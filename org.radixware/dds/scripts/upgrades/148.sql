...
alter table RDX_SM_INSTANCESTATEHISTORY drop column PRIMARYUNITID
/

alter table RDX_SM_INSTANCESTATEHISTORY rename column CPUDIFFNANOS to CPUDIFFMILLIS
/

alter table RDX_SM_INSTANCESTATEHISTORY rename column DBDIFFNANOS to DBDIFFMILLIS
/

alter table RDX_SM_INSTANCESTATEHISTORY rename column EXTDIFFNANOS to EXTDIFFMILLIS
/

alter table RDX_SM_INSTANCESTATEHISTORY rename column OTHERDIFFNANOS to QUEUEDIFFMILLIS
/
