...
create table RDX_AADCOGGERROR(
	FILESEQNO NUMBER not null,
	FILERBA NUMBER not null,
...
grant select, update, insert, delete on RDX_AADCOGGERROR to &USER&_RUN_ROLE
/

create unique index PK_RDX_AADCOGGERROR on RDX_AADCOGGERROR (FILERBA asc, FILESEQNO asc)
/

alter table RDX_AADCOGGERROR add constraint PK_RDX_AADCOGGERROR primary key (FILERBA, FILESEQNO) rely
/
