...
public class JMLPrefixExpression extends PrefixExpression implements IJMLExpression {

    private Expression substitution;
    private boolean wasResolved;

    public JMLPrefixExpression(PrefixExpression src) {
        super(src.lhs, src.expression, src.operator, 0);
