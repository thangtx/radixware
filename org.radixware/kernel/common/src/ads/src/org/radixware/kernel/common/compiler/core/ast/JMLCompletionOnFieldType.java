 ...
 * @author akrylov
 */
public class JMLCompletionOnFieldType extends CompletionOnFieldType {

    public JMLCompletionOnFieldType(CompletionOnFieldType src) {
        super(src.type, src.isLocalVariable);
