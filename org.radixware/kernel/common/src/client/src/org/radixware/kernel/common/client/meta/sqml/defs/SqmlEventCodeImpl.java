...
final class SqmlEventCodeImpl implements ISqmlEventCodeDef {
    ...
    public SqmlEventCodeImpl(final RadMlStringBundleDef bundle, final Id stringId) {
    ...
    private String getShortText() {
        final int newLine = eventCode.indexOf(System.lineSeparator());
    ...
    @Override
    public Id[] getIdPath() {
        return new Id[]{bundle.getId()};
    }

    @Override
    public boolean isDeprecated() {
        return bundle.isDeprecated();
    }
}