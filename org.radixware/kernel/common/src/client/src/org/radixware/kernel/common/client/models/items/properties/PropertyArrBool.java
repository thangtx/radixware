...
public class PropertyArrBool extends PropertyArr<ArrBool> {

    public PropertyArrBool(Model owner, RadPropertyDef propDef) {
        super(owner, propDef);
    }
    ...
    public Class<?> getValClass() {
        return ArrBool.class;
    }

    @Override
    public void setValObjectImpl(Object x) {
        setInternalVal((ArrBool) x);
    }
