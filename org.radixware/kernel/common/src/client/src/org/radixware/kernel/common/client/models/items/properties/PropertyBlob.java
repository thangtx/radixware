...
public class PropertyBlob extends SimpleProperty<Bin> {

    public PropertyBlob(Model owner, RadPropertyDef propDef) {
        super(owner, propDef);
    }
    ...
    public IPropEditor createPropertyEditor() {
        return getEnvironment().getApplication().getStandardViewsFactory().newPropBlobEditor(this);
    }
