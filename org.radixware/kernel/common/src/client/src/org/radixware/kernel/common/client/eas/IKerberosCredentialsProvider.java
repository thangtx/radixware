...
public interface IKerberosCredentialsProvider {
    KerberosCredentials createCredentials(IClientEnvironment environment) throws InterruptedException, KerberosError;
}
