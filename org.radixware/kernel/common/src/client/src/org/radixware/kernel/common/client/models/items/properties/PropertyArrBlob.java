...
public class PropertyArrBlob extends PropertyArr<ArrBin> {

    public PropertyArrBlob(Model owner, RadPropertyDef propDef) {
        super(owner, propDef);
    }
    ...
    public void setValObjectImpl(Object x) {
        setInternalVal((ArrBin) x);
    }

    @Override
    public final EValType getType() {
        return EValType.ARR_BLOB;
    }
}
