...
class RfsRepositoryDdsSegment extends RfsRepositorySegment<DdsModule> {

    RfsRepositoryDdsSegment(RfsRepositoryLayer layer, DirectoryMeta dir) {
        super(layer, dir, ERepositorySegmentType.DDS);
    }

    @Override
    protected IRepositoryModule<DdsModule> createModule(String moduleDirName) {
        return new RfsRepositoryDdsModule(this, moduleDirName);
    }
