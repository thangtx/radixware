/**
 * DataWriter.java - XML writer for data-oriented files. XMLWriter.java -
 * serialize an XML document. Written by David Megginson, david@megginson.com NO
 * WARRANTY! This class is in the public domain.
 *
 */
 ...
 * indentation and newlines will be passed on down the filter chain (if
 * any).</p>
 *
 * <p>
 ...
 * line with leading indentation. Consider, for example, the following code:</p>
 *
 * <pre>
 ...
 *
 * <p>
 * This code will produce the following document:</p>
 *
 * <pre>
 ...
 *
 * <p>
 * This class inherits from {@link com.megginson.sax.XMLWriter
...
public class DataWriter extends XMLWriter {
     ...
     *
     * <p>
     * Use the XMLReader provided as the source of events.</p>
     *
     ...
     *
     * @param writer The character stream where the XML document will be
     * written.
     */
     ...
     * start tag, or if a filter further down the chain raises an exception.
     ...
     * @param atts The element's attribute list.
     * @exception org.xml.sax.SAXException If there is an error writing the
     * empty tag, or if a filter further down the chain raises an exception.
