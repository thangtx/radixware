 ...
 */
public class DefinitionAmbiguousError extends DefinitionError {

    protected final Id definitionId;
     ...
     * @param definitionId
     */
    public DefinitionAmbiguousError(Id definitionId) {
     ...
     */
    public DefinitionAmbiguousError(Id definitionId, Throwable cause) {
