...
class NestedScmlPrinter4ORACLE extends NestedScmlCodePrinter {

    private static final String COMMAND_SEPARATOR = "\n/\n\n";
//    private static final String COMMAND_SEPARATOR = ";\n\n";

    protected NestedScmlPrinter4ORACLE(final ScmlCodePrinter container) {
        super(container);
        putProperty(DATABASE_TYPE,EDatabaseType.ORACLE);
    }
