...
public class ShouldNeverHappenError extends RadixError {

    public ShouldNeverHappenError(String mess, Throwable cause) {
        super(mess, cause);
    }
    
    public ShouldNeverHappenError(String mess) {
        super(mess);
    }
