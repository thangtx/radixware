...
public class LoginDialog extends javax.swing.JPanel {
    ...
    private static class Holder {
        ...
        AuthenticationCancelledException ex = null;
        String password = null;
    }
    
    public static class PasswordGetter implements IPasswordGetter{
        @Override
        public String getPassword(boolean isFirstTime, ESvnAuthType svnAuthType, String title, String targetName, String target, String user) throws AuthenticationCancelledException {
            return LoginDialog.getPassword(title, targetName, target, user);
        }
    }
    

    public static String getPassword(final String title, final String targetName, final String target, final String user) throws AuthenticationCancelledException {
        if (EventQueue.isDispatchThread()) {
            Reference<String> user_ref = null;
            if (user != null) {
                user_ref = new Reference<String>(user);
            }
            Reference<String> pwd_ref = new Reference<String>();
