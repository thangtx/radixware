...
public class XmlStrEnumList extends XmlListImpl {

    private static final long serialVersionUID = -2409849867270355413L;
    private final TypeMapper mapperTo, mapperFrom;

    @SuppressWarnings("unchecked")
    public XmlStrEnumList(Class enumClass, SchemaType type, boolean complex) {
        super(type, complex);
        mapperTo = new StrEnum2String(enumClass);
