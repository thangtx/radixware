...
public class AdsAppObjectPropChecker<T extends AdsAppObject.Prop> extends AdsDefinitionChecker<T> {

    public AdsAppObjectPropChecker() {
    }

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return AdsAppObject.Prop.class;
    }
