...
public class DdsLocalizingBundleChecker extends DefinitionChecker<DdsLocalizingBundleDef> {

    public DdsLocalizingBundleChecker() {
    }

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return DdsLocalizingBundleDef.class;
    }

    @Override
    public void check(DdsLocalizingBundleDef radixObject, IProblemHandler problemHandler) {
    }
}