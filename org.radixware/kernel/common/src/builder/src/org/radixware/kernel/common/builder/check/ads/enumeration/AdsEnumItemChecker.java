...
public class AdsEnumItemChecker extends AdsDefinitionChecker<AdsEnumItemDef> {

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return AdsEnumItemDef.class;
    }

    @Override
    public void check(AdsEnumItemDef definition, IProblemHandler problemHandler) {
