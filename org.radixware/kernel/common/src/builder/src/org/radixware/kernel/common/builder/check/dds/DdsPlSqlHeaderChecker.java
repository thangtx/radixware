...
public class DdsPlSqlHeaderChecker<T extends DdsPlSqlHeaderDef> extends DdsDefinitionChecker<T> {

    public DdsPlSqlHeaderChecker() {
    }

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return DdsPlSqlHeaderDef.class;
    }
