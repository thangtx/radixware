...
public class AdsClassCatalogTopicChecker extends AdsDefinitionChecker<AdsClassCatalogDef.Topic> {

    public AdsClassCatalogTopicChecker() {
    }

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return AdsClassCatalogDef.Topic.class;
    }
}
