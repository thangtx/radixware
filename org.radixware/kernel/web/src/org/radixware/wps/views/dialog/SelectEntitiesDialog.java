...
public class SelectEntitiesDialog extends SelectEntityDialog implements ISelectEntitiesDialog{
    ...
    public SelectEntitiesDialog(final IDialogDisplayer displayer, final GroupModel groupModel, final boolean canBeNull){
        super(displayer, groupModel,canBeNull);
    }        
