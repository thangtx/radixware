...
final class XmlValConstSetEditorController extends ValConstSetEditorController {

    private final SchemaType schemaType;
    private boolean validationEnabled;

    public XmlValConstSetEditorController(final IClientEnvironment env, final EditMaskConstSet editMask, final SchemaType schemaType) {
        super(env, editMask);
