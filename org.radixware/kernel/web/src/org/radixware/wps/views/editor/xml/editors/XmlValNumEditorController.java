...
final class XmlValNumEditorController extends ValNumEditorController {

    private final SchemaType schemaType;
    private boolean validationEnabled;

    public XmlValNumEditorController(final IClientEnvironment env, final SchemaType schemaType) {
        super(env);
    ...
    @Override
    protected ValidationResult calcValidationResult(BigDecimal value) {
