...
import org.radixware.kernel.explorer.inspector.propertyEditors.QPalettePropertyEditor;

public class QPaletteInspectorDelegate implements InspectorDelegate {

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new QPalettePropertyEditor(environment, parent);
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(QPalette.class);
    }
