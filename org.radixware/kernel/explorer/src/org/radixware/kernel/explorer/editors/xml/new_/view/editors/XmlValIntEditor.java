...
final class XmlValIntEditor extends ValIntEditor {

    private final SchemaType schemaType;

    public XmlValIntEditor(final IClientEnvironment environment, final EditMaskInt editMaskInt,
            final boolean mandatory, final boolean readOnly, final SchemaType schemaType) {
        super(environment, null, editMaskInt, mandatory, readOnly);
