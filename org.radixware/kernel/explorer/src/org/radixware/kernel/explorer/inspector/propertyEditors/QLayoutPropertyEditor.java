...
public class QLayoutPropertyEditor extends ValStrEditor implements IPropertyEditor {

    private final ValueListenerController valListenerController = new ValueListenerController();

    public QLayoutPropertyEditor(IClientEnvironment environment, QWidget parent) {
        ...
        childPropEditor.addValueListener(new ValueListener() {
            ...
            public void onChangeValue(Object newValue) {
                try {
                    ...
                    QLayoutPropertyEditor.super.getEnvironment().getTracer().error(ex);
                }
            }
        });
    }
    ...
    public boolean setPropertyValue(WidgetProperty property) {
        ...
        if (property.getValue() != null) {
            this.setValue(property.getValue().getClass().getSimpleName());
        } else {
            this.setValue("not defined");
        }
        return true;
    }
