...
public class PropCharEditor extends PropEditor {
    ...
    public PropCharEditor(final Property property) {
        this(property, getValEditorFactory());
    }
    
    protected PropCharEditor(final Property property, final ValEditorFactory factory){
    ...
    public final EWidgetMarker getWidgetMarker() {
        return EWidgetMarker.CHAR_PROP_EDITOR;
    }    
}
