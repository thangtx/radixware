...
import org.radixware.kernel.explorer.inspector.propertyEditors.QSizePolicyStretchPropertyEditor;

public class QSizePolicyStretchInspectorDelegate implements InspectorDelegate{

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new QSizePolicyStretchPropertyEditor();
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(int.class);
    }
