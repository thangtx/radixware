...
public class JmlTag_Type extends TagInfo{
    
    private static final String path = "org.radixware.explorer/S_E/SYNTAX_JML/JML_TAG_TYPE";
    private  JmlTagTypeDeclaration tag;
    
    public JmlTag_Type(final IClientEnvironment environment, JmlTagTypeDeclaration tag){
        super(environment);
    ...
    public IScmlItem getCopy() {
        return new JmlTag_Type(  environment,  tag);        
    }
