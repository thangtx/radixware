...
public class QRectPropertyEditor extends ValStrEditor implements IPropertyEditor {

    private final ValueListenerController valListenerController = new ValueListenerController();

    public QRectPropertyEditor(IClientEnvironment environment, QWidget parent) {
    ...
    public boolean setPropertyValue(WidgetProperty property) {
        ...
        this.setValue("X = " + ((QRect) property.getValue()).x() + ", Y = " + ((QRect) property.getValue()).y()
                + ", height = " + ((QRect) property.getValue()).height() + ", width = " + ((QRect) property.getValue()).width());
        return true;
    }
        ...
        childPropEditor.addValueListener(new ValueListener() {
            ...
            public void onChangeValue(Object newValue) {
                try {
                    ...
                    QRectPropertyEditor.super.getEnvironment().getTracer().error(ex);
                }
            }
        });
    }
