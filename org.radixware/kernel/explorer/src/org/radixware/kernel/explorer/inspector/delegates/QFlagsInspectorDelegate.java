...
import org.radixware.kernel.explorer.inspector.propertyEditors.QFlagsPropertyEditor;

public class QFlagsInspectorDelegate implements InspectorDelegate {

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new QFlagsPropertyEditor(environment, parent);
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(Qt.Alignment.class);
    }
