...
final class ElementClickCmd extends GuiCmd{
    ...
    public JSONObject execute(final WebDrvSession session, final WebDrvUri uri, final JSONObject parameter) throws WebDrvException {
        ...
        final UIElementReference ref = manager.getUIElementReference(uri.getElementId());
        ref.clickAtCenterPoint(session.getUIElements());
        return null;
    }
}
