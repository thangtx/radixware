...
public class QSizePropertyEditor extends ValStrEditor implements IPropertyEditor {

    private final ValueListenerController valListenerController = new ValueListenerController();

    public QSizePropertyEditor(IClientEnvironment environment, QWidget parent) {
    ...
    public boolean setPropertyValue(WidgetProperty property) {
        ...
        this.setValue("height = " + ((QSize) property.getValue()).height() + ", width = " + ((QSize) property.getValue()).width());
        return true;
    }
        ...
        childPropEditor.addValueListener(new ValueListener() {
            ...
            public void onChangeValue(Object newValue) {
                try {
                    ...
                    QSizePropertyEditor.super.getEnvironment().processException("Fail to set " + childWdgtProperty.getName(), ex);
                }
            }
        });
    }
