...
public class GcmUnit extends PersoCommUnit {
    ...
    private static final String FIELD_NTF_BADGE = "badge";
    ...
    public GcmUnit(final Instance instModel, final Long id, final String title) {
    ...
    protected class WriteGcmCommunicationAdapter implements ICommunicationAdapter {

        final URL sendAddress;
        ...
        private JSONObject prepareMessage(MessageDocument md) throws DPCSendException {
            ...
            if (xMessage.isSetBody() || xMessage.isSetTitle() || xMessage.isSetBadge()) {
                ...
                if (xMessage.isSetBadge()) {
                    notificationObj.put(FIELD_NTF_BADGE, xMessage.getBadge());
                }                
                ...
                if (xMessage.isSetSound()) {
                    notificationObj.put(FIELD_NTF_SOUND, xMessage.getSound());
                }
        ...
        public MessageSendResult sendMessage(MessageWithMeta messageWithMeta) throws DPCSendException {
            ...
            final JSONObject msg = prepareMessage(md);
            ...
            try {
                ...
                if (conn.getResponseCode() != 200) {
                    final String response = conn.getErrorStream() == null ? null :  IOUtils.toString(conn.getErrorStream(), "UTF-8");
                ...
                getTrace().put(EEventSeverity.DEBUG, ExceptionTextFormatter.exceptionStackToString(ex), null, null, getEventSource(), false);
    ...
    protected class ReadGcmCommunicationAdapter implements ICommunicationAdapter {
