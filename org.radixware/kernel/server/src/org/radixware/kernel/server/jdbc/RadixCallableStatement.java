...
public class RadixCallableStatement extends RadixPreparedStatement implements OracleCallableStatement {

    private final OracleCallableStatement delegate;

    public RadixCallableStatement(final RadixConnection radixConnection, OracleCallableStatement delegate, final String sql) {
        super(radixConnection, delegate, sql);
