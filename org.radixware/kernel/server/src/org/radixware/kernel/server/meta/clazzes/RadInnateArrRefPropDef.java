...
public final class RadInnateArrRefPropDef extends RadInnatePropDef implements IRadRefPropertyDef {

    private final Id destClassId;
    private DdsTableDef destTable = null;

    public RadInnateArrRefPropDef(
            final Id id,
            final String name,
            final Id titleId,
        ...
        super(id, name, titleId, EValType.ARR_REF, null, isValInheritable, valInheritMarkValAsStr, valInheritPathes, initPolicy, initVal, accessor);
