...
class PathTitleLocalizingEditor extends TopComponent {
...
//            strForLang.put(language, newStringValue);
    ...
    protected PathTitleLocalizingEditor(AdsDefinition definition, AdsMultilingualStringDef stringDef) {
        super();
        ...
        updating = true;
        if (stringDef != null && stringDef.getId() != null) {
...
//        for (EIsoLanguage lang : EIsoLanguage.values())
    ...
    private void setupTitle() {
        ...
        titleTextField.setText(stringDef.findValue(EIsoLanguage.ENGLISH));
...
//        }
    ...
    private class TitleModalDisplayer extends ModalDisplayer {
        ...
        public TitleModalDisplayer(PathTitleLocalizingEditor editor) {
            super(editor);
...
//        }
        ...
        protected void apply() {
            if (translationCheckBox.isSelected()) {
                ...
                stringDef.setValue(EIsoLanguage.ENGLISH, titleTextField.getText());
            }
        }
    }
    ...
    public String getDisplayName() {
        return NbBundle.getBundle(PathTitleLocalizingEditor.class).getString("Title_Editor");
    }
    ...
    public static final class Factory {
        ...
        public static PathTitleLocalizingEditor newInstance(AdsDefinition definition, AdsMultilingualStringDef stringDef) {
            return new PathTitleLocalizingEditor(definition, stringDef);
        }
    ...
    private void initComponents() {
        ...
        titleTextField.setText(org.openide.util.NbBundle.getMessage(PathTitleLocalizingEditor.class, "PathTitleLocalizingEditor.titleTextField.text")); // NOI18N
        ...
        translationCheckBox.setText(org.openide.util.NbBundle.getMessage(PathTitleLocalizingEditor.class, "PathTitleLocalizingEditor.translationCheckBox.text")); // NOI18N
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PathTitleLocalizingEditor.class, "PathTitleLocalizingEditor.panel.border.title"))); // NOI18N
