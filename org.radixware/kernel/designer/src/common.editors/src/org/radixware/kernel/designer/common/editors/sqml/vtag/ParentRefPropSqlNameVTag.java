...
public class ParentRefPropSqlNameVTag<T extends ParentRefPropSqlNameTag> extends SqmlVTag<T> {

    public ParentRefPropSqlNameVTag(T tag) {
        super(tag);
    }
    ...
    public String getTokenName() {
        return "tag-parent-ref-prop-sql-name";
    }
}
