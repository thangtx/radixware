...
public class AdsReportCellNode extends RadixObjectNode {
...
//    }
    ...
    protected AdsReportCellNode(final AdsReportCell cell) {
    ...
    public static class Factory implements INodeFactory<AdsReportCell> {

        @Override
        public RadixObjectNode newInstance(final AdsReportCell cell) {
            return new AdsReportCellNode(cell);
        }
    }
}
