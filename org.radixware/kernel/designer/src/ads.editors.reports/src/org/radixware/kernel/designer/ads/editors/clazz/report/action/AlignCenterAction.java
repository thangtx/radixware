...
public class AlignCenterAction extends AbstractAction {
    ...
    public AlignCenterAction(AdsReportFormDiagram diagram) {
        super("Align Center", RadixWareIcons.ALIGN.DIAGRAM.CENTER.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        final double mid = (minLeft + maxRight) / 2;
        for (AdsReportCell cell : cells) {
            cell.setLeftMm(mid - cell.getWidthMm() / 2);
        }
    }
