...
public class TopBorderAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public TopBorderAction(final AdsReportFormDiagram diagram) {
        super("Top Border", RadixWareIcons.BORDER.TOP_BORDER.getIcon());
