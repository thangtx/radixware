...
public class VAlignAdjustAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public VAlignAdjustAction(final AdsReportFormDiagram diagram) {
        super("Adjust Cell Size", RadixWareIcons.ALIGN.DIAGRAM.ADJUST.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        for (RadixObject obj : diagram.getSelectedObjects()) {
            if (obj instanceof AdsReportCell) {
                ...
                //cell.setVAlign(EReportCellVAlign.ADJUST);
