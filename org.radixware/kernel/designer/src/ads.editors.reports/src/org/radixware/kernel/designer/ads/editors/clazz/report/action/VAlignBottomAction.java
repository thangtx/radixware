...
public class VAlignBottomAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public VAlignBottomAction(final AdsReportFormDiagram diagram) {
        super("Bottom", RadixWareIcons.ALIGN.TEXT.CENTER_BOTTOM.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        for (RadixObject obj : diagram.getSelectedObjects()) {
            if (obj instanceof AdsReportCell) {
                ...
                cell.setVAlign(EReportCellVAlign.BOTTOM);
            }
        }
    }
