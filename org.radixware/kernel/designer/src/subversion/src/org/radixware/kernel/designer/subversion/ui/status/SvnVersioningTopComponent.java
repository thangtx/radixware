 ...
 */
//@ConvertAsProperties(dtd = "-//org.radixware.kernel.designer.subversion.ui.status//SvnVersioning//EN",
//autostore = false)
public final class SvnVersioningTopComponent extends TopComponent implements Externalizable {

    private static final long serialVersionUID = 1L;
    private static final String PREFERRED_ID = "SvnVersioningTopComponent";
    ...
    public static synchronized SvnVersioningTopComponent getDefault() {
        if (instance == null) {
    ...
    /**
     * Obtain the SvnVersioningTopComponent instance. Never call {@link #getDefault} directly!
     */
    public static synchronized SvnVersioningTopComponent findInstance() {
        TopComponent win = WindowManager.getDefault().findTopComponent(PREFERRED_ID);
        if (win == null) {
            Logger.getLogger(SvnVersioningTopComponent.class.getName()).warning(
                    "Cannot find " + PREFERRED_ID + " component. It will not be located properly in the window system.");
            return getDefault();
        }
        if (win instanceof SvnVersioningTopComponent) {
            return (SvnVersioningTopComponent) win;
        }
        Logger.getLogger(SvnVersioningTopComponent.class.getName()).warning(
