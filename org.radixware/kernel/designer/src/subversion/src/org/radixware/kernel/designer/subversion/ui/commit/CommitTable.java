...
public class CommitTable implements AncestorListener, TableModelListener, MouseListener {
    ...
    private final CommitAction.CommitInputAwtParameters awtParameters;

    public CommitTable(final CommitAction.CommitInputAwtParameters awtParameters, JLabel label, String[] columns, Map<String, Integer> sortByColumns) {
        this.awtParameters = awtParameters;
    ...
    private class CommitStringsCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (CommitTableModel.COLUMN_NAME_NAME.equals(columns[col])) {
                ...
                if (!isSelected) {
                    // RADIX
                    value = Subversion.getInstance().getAnnotator().annotateNameHtml(value.toString(), node.getInformation(), null);
                }
    ...
    private class FileNameComparator implements Comparator {
        ...
        public int compare(Object o1, Object o2) {
            ...
            Integer row2 = (Integer) o2;
            // RADIX
            String fileDisplayName1 = RadixFileUtil.getFileDisplayName(tableModel.getNode(row1.intValue()).getFile());
            // RADIX
            String fileDisplayName2 = RadixFileUtil.getFileDisplayName(tableModel.getNode(row2.intValue()).getFile());
            // RADIX
            return fileDisplayName1.compareToIgnoreCase(fileDisplayName2);
            // RADIX
