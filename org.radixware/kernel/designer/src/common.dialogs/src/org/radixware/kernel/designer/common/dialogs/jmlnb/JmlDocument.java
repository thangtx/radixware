...
public class JmlDocument extends ScmlDocument {

    private CompletionRegion completionRegion;

    public JmlDocument(String mimeType) {
        super(mimeType);
    ...
    public Scml createDefaultScml() {
        return Jml.Factory.newInstance(null, "default-jml");
    }
    ...
    private static class CompletionRegion implements TagCompletionRegion {
        ...
        private int start;
        private int end;
        private Scml.Item item = Scml.Text.Factory.newInstance("ta-da!");
