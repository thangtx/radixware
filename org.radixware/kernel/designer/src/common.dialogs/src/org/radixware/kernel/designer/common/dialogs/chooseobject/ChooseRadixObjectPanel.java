...
public class ChooseRadixObjectPanel extends javax.swing.JPanel {

    public ChooseRadixObjectPanel() {
        initComponents();
        listPanel.attachExternalComponents(nameField, caseSensitive);
    }

    private void updateLabels(ChooseRadixObjectCfg cfg) {
        org.openide.awt.Mnemonics.setLocalizedText(jLabelText, NbBundle.getMessage(ChooseRadixObjectPanel.class, "TXT_GoToElement_ElementName_Label", cfg.getTypeTitle()));
        jLabelList.setText(NbBundle.getMessage(ChooseRadixObjectPanel.class, "TXT_GoToElement_MatchesList_Label", cfg.getTypesTitle()));
    }
    ...
    private void initComponents() {
        ...
        listPanel = new org.radixware.kernel.designer.common.dialogs.chooseobject.RadixObjectsPanel();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabelText, org.openide.util.NbBundle.getMessage(ChooseRadixObjectPanel.class, "TXT_GoToElement_ElementName_Label")); // NOI18N
        ...
        jLabelList.setText(org.openide.util.NbBundle.getMessage(ChooseRadixObjectPanel.class, "TXT_GoToElement_MatchesList_Label")); // NOI18N
        jPanel1.add(jLabelList, java.awt.BorderLayout.WEST);

        org.openide.awt.Mnemonics.setLocalizedText(caseSensitive, org.openide.util.NbBundle.getMessage(ChooseRadixObjectPanel.class, "TXT_GoToElement_CaseSensitive")); // NOI18N
    ...
    private org.radixware.kernel.designer.common.dialogs.chooseobject.RadixObjectsPanel listPanel;
