...
class ChooseDefinitionModalDisplayer extends ModalDisplayer implements IChooseDefinitionModalDisplayer {

    private final ChooseDefinitionPanel panel;
    private final ChooseDefinitionCfg cfg;
    private List<Definition> result = null;

    public ChooseDefinitionModalDisplayer(final ChooseDefinitionPanel panel, ChooseDefinitionCfg cfg, boolean multipleSelectionAllowed) {
        super(panel);
