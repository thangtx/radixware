...
final class JmlDeleteToNextCCPosition extends JmlSelectNextCCPosition {

    public JmlDeleteToNextCCPosition(Action originalAction) {
        super(JmlKit.deleteNextCamelCasePosition, originalAction);
    }
