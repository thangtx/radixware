...
import org.radixware.kernel.designer.tree.ads.nodes.defs.clazz.ClassMethodGroupsProvider;
import org.radixware.kernel.designer.tree.ads.nodes.defs.clazz.ClassMethodsProvider;
import org.radixware.kernel.common.defs.ads.clazz.AdsClassDef;
import org.radixware.kernel.designer.tree.ads.nodes.defs.clazz.*;


class AdsAlgoClassNode extends AdsAbstractClassNode {

    public static final class Factory {
    }

    public AdsAlgoClassNode(AdsClassDef definition) {
        super(definition);
    }
    @SuppressWarnings("unchecked")
    private static final Class<? extends MixedNodeChildrenProvider>[] simpleClassProviders = new Class[]{
        ClassPageProviderRoot.class,
