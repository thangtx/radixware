...
public class AdsEditorPresentationNode extends AdsMixedNode<AdsEditorPresentationDef> {
    ...
    public static class Factory implements INodeFactory<AdsEditorPresentationDef> {

        @Override // Registered in layer.xml
        public RadixObjectNode newInstance(AdsEditorPresentationDef ddsPlSqlObject) {
            return new AdsEditorPresentationNode(ddsPlSqlObject);
        }
    }

    public AdsEditorPresentationNode(AdsEditorPresentationDef definition) {
        super(definition);
    }
}
