...
public class MakeVersionCurrentAction extends CookieAction {
    ...
    public static class Cookie implements Node.Cookie {
        ...
        private void process() {
            ProgressUtils.showProgressDialogAndRun(new Runnable() {
                @Override
                public void run() {
                    UserExtensionManager.getInstance().makeCurrent( null, true, version, version.getOwnerReport());
                    //version.makeCurrent(null, true,version);
                }
    ...
    public String getName() {
        return "Set This Version as Current";
    }
