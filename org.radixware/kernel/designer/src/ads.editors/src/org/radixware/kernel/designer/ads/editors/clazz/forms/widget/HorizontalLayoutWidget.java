...
public class HorizontalLayoutWidget extends BaseWidget {

    public HorizontalLayoutWidget(GraphSceneImpl scene, AdsLayout node) {
        super(scene, node);
        setLayoutProcessor(new HorizontalLayoutProcessor(this, node));
    }
