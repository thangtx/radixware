...
public class CheckButtonWidget extends BaseWidget {

    public CheckButtonWidget(GraphSceneImpl scene, AdsWidgetDef node) {
        super(scene, node);
    }

    public CheckButtonWidget(GraphSceneImpl scene, AdsRwtWidgetDef node) {
        super(scene, node);
    }
