...
import org.radixware.kernel.designer.ads.editors.clazz.forms.dialog.ComboBoxPanel;
...
public class ComboBoxWidget extends BaseWidget {
    ...
    public ComboBoxWidget(GraphSceneImpl scene, AdsItemWidgetDef node) {
        super(scene, node);
    }
    ...
    protected boolean notifyEdited() {
        ...
        return EditorDialog.execute(new ComboBoxPanel(((GraphSceneImpl) getScene()).getUI(), widget));
    }
}
