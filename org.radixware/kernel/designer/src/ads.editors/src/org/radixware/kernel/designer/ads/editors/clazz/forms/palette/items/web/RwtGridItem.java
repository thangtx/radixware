...
public class RwtGridItem extends Item {

    public static final RwtGridItem DEFAULT = new RwtGridItem();

    public RwtGridItem() {
        super(Group.GROUP_WEB_ITEM_WIDGETS, "Table", AdsMetaInfo.RWT_UI_GRID);
    }
    ...
    public void paintBackground(Graphics2D graphics, Rectangle rect, RadixObject node) {
        DrawUtil.drawPlainRect(graphics, rect, DrawUtil.COLOR_DARK, 1, DrawUtil.COLOR_BASE);
    }
}
