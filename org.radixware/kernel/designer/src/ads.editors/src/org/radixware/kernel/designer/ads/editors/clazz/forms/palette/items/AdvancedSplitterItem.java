...
public class AdvancedSplitterItem extends Item {

    public static final AdvancedSplitterItem DEFAULT = new AdvancedSplitterItem();

   

    public AdvancedSplitterItem() {
        super(Group.GROUP_CONTAINERS, NbBundle.getMessage(AdvancedSplitterItem.class, "Advanced_Splitter"), AdsMetaInfo.ADVANCED_SPLITTER_CLASS);
    }
