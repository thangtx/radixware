...
import org.radixware.kernel.designer.ads.editors.clazz.forms.dialog.*;


public class TreeWidget extends BaseWidget {

    public TreeWidget(GraphSceneImpl scene, AdsItemWidgetDef node) {
        super(scene, node);
    }
    ...
    protected boolean notifyEdited() {
        ...
        return EditorDialog.execute(new TreePanel(((GraphSceneImpl) getScene()).getUI(),widget));
    }
}
