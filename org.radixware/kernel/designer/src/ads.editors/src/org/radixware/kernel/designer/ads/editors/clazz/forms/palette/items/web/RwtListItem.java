...
public class RwtListItem extends Item {

    public static final RwtListItem DEFAULT = new RwtListItem();

    public RwtListItem() {
        super(Group.GROUP_WEB_ITEM_WIDGETS, "List", AdsMetaInfo.RWT_UI_LIST);
    }
