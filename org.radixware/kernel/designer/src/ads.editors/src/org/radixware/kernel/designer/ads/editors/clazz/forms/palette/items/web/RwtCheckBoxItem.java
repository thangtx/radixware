...
public class RwtCheckBoxItem extends Item {

    public static final RwtCheckBoxItem DEFAULT = new RwtCheckBoxItem();

    public RwtCheckBoxItem() {
        super(Group.GROUP_WEB_BUTTONS, "Check Box", AdsMetaInfo.RWT_UI_CHECK_BOX);
    }
