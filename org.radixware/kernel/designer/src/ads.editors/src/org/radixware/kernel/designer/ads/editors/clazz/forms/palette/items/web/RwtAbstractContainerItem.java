...
public class RwtAbstractContainerItem extends Item {

    public static final RwtAbstractContainerItem DEFAULT = new RwtAbstractContainerItem();

    public RwtAbstractContainerItem() {
        super(Group.GROUP_WEB_CONTAINERS, "Simple Container", AdsMetaInfo.RWT_UI_ABSTRACT_CONTAINER);
    }
