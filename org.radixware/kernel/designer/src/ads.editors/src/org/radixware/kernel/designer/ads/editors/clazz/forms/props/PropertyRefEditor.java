...
public class PropertyRefEditor extends PropertyEditorSupport implements ExPropertyEditor {

    private PropertyEnv env;

    public PropertyRefEditor(UIPropertySupport property) {
        super(property);
    }

    @Override
    public String getAsText() {
        AdsUIProperty.PropertyRefProperty prop = (AdsUIProperty.PropertyRefProperty)getValue();
        IModelPublishableProperty propDef = prop.findProperty();
        return String.format("%s", propDef != null ? propDef.getName() : "");
    }
    ...
    public java.awt.Component getCustomEditor () {
        return new PropertyRefPanel(this, env);
    }
