...
public class RwtTreeItem extends Item {

    public static final RwtTreeItem DEFAULT = new RwtTreeItem();

    public RwtTreeItem() {
        super(Group.GROUP_WEB_ITEM_WIDGETS, "Tree", AdsMetaInfo.RWT_UI_TREE);
    }
