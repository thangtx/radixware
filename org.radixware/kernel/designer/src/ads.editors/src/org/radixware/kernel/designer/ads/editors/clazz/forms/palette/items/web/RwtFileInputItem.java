...
public class RwtFileInputItem extends Item {

    public static final RwtFileInputItem DEFAULT = new RwtFileInputItem();

    public RwtFileInputItem() {
        super(Group.GROUP_WEB_INPUTS, "File Input", AdsMetaInfo.RWT_UI_FILE_INPUT);
    }
