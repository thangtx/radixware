...
public class GroupBoxWidget extends BaseWidget {
    ...
    public GroupBoxWidget(GraphSceneImpl scene, AdsWidgetDef node) {
        super(scene, node);
    ...
    protected List<WidgetAction> getInitialActions(GraphSceneImpl scene, RadixObject node) {
        ...
        actions.add(createInplaceEditorAction("title", EnumSet.of(InplaceEditorProvider.ExpansionDirection.BOTTOM)));
        return actions;
    }
