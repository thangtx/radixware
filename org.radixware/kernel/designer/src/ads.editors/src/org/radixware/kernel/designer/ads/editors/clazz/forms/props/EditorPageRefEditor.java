...
public class EditorPageRefEditor extends PropertyEditorSupport implements ExPropertyEditor {

    private PropertyEnv env;

    public EditorPageRefEditor(UIPropertySupport property) {
        super(property);
    }
    ...
    public String getAsText() {
        AdsUIProperty.EditorPageRefProperty prop = (AdsUIProperty.EditorPageRefProperty)getValue();
        AdsEditorPageDef page = prop.findEditorPage();
        return String.format("%s", page != null ? page.getName() : "");
    }
    ...
    public java.awt.Component getCustomEditor () {
        return new EditorPageRefPanel(this, env);
    }
