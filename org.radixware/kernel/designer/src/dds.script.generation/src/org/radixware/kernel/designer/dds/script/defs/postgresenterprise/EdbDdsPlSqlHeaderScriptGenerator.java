...
public class EdbDdsPlSqlHeaderScriptGenerator extends EdbDdsPlSqlPartScriptGenerator<DdsPlSqlHeaderDef> {

    public EdbDdsPlSqlHeaderScriptGenerator() {
    }
    ...
    public void getCreateScript(CodePrinter cp, DdsPlSqlHeaderDef header, IScriptGenerationHandler handler) {
        ...
        cp.print("create or replace ").print(getSqlClassName(header)).print(' ').print(plSqlObject.getDbName()).print(" as");
        ...
        if (plSqlObject instanceof DdsTypeDef) {
            ...
            for (DdsTypeFieldDef field : type.getFields()) {
                ...
                cp.print('\t').print(DdsScriptInternalUtils.escapeDbName(field.getDbName())).print(' ').print(DdsScriptInternalUtils.convertFieldDbType(field.getDbType()));
    ...
    @Override
    public void getRunRoleScript(CodePrinter cp, DdsPlSqlHeaderDef part) {
        final DdsPlSqlObjectDef plSqlObject = part.getPlSqlObjectDef();
                
        if (!(plSqlObject instanceof DdsTypeDef)) {
            cp.print("grant execute on ").print(getSqlClassName(part)).print(' ').print(part.getPlSqlObjectDef().getDbName()).print(" to &USER&_RUN_ROLE").printCommandSeparator();
        }
    }
    ...
    public static final class Factory {
        ...
        public static EdbDdsPlSqlHeaderScriptGenerator newInstance() {
            return new EdbDdsPlSqlHeaderScriptGenerator();
        }
    }
}
