...
package org.radixware.kernel.designer.dds.script.uptriggers;
...
public class UserPropTriggersUpdater {
    ...
    public UserPropTriggersUpdater(final DdsTableDef table) {
        this.table = table;
    }
    ...
    public void update() {
        ...
        final String postfix = tableIdAsStr.toString().substring(3);
    ...
    public static void update(DdsTableDef table) {
        final UserPropTriggersUpdater updater = new UserPropTriggersUpdater(table);
        updater.update();
    }
