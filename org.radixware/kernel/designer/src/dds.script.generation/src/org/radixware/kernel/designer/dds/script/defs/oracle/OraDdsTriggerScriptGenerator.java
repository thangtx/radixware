 ...
 */
public class OraDdsTriggerScriptGenerator implements IDdsDefinitionScriptGenerator<DdsTriggerDef> {

    protected OraDdsTriggerScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static OraDdsTriggerScriptGenerator newInstance() {
            return new OraDdsTriggerScriptGenerator();
        }
    }
