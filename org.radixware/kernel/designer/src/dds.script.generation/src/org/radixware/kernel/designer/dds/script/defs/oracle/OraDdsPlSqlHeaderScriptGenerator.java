...
public class OraDdsPlSqlHeaderScriptGenerator extends OraDdsPlSqlPartScriptGenerator<DdsPlSqlHeaderDef> {

    public OraDdsPlSqlHeaderScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static OraDdsPlSqlHeaderScriptGenerator newInstance() {
            return new OraDdsPlSqlHeaderScriptGenerator();
        }
    }
}
