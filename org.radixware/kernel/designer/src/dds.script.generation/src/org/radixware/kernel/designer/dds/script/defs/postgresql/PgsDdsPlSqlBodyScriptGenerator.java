...
public class PgsDdsPlSqlBodyScriptGenerator extends PgsDdsPlSqlPartScriptGenerator<DdsPlSqlBodyDef> {

    public PgsDdsPlSqlBodyScriptGenerator() {
    }
        ...
        for (DdsPlSqlObjectItemDef item : plSqlObject.getBody().getItems()) {
            ...
            if (item instanceof DdsFunctionDef) {
                ...
                if (function.isGeneratedInDb()) {
                    cp.print("\n\n");
                    PgsDdsFunctionScriptGenerator.getScript(cp, function, handler);
                }
    ...
    public static final class Factory {
        ...
        public static PgsDdsPlSqlBodyScriptGenerator newInstance() {
            return new PgsDdsPlSqlBodyScriptGenerator();
        }
    }
}
