 ...
 */
public class OraDdsSequenceScriptGenerator implements IDdsDefinitionScriptGenerator<DdsSequenceDef> {

    protected OraDdsSequenceScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static OraDdsSequenceScriptGenerator newInstance() {
            return new OraDdsSequenceScriptGenerator();
        }
    }
}
