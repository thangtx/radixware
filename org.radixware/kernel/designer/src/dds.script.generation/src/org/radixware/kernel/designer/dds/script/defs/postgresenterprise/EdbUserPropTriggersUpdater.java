...
public class EdbUserPropTriggersUpdater {
    ...
    public EdbUserPropTriggersUpdater(final DdsTableDef table) {
        this.table = table;
    }
    ...
    public static void update(DdsTableDef table) {
        final EdbUserPropTriggersUpdater updater = new EdbUserPropTriggersUpdater(table);
        updater.update();
    }
