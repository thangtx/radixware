...
public class PgsDdsCheckConstraintScriptGenerator extends PgsDdsConstraintScriptGenerator<DdsCheckConstraintDef> {

    protected PgsDdsCheckConstraintScriptGenerator() {
    }
    ...
    public boolean isModifiedToDrop(DdsCheckConstraintDef oldCheckConstraint, DdsCheckConstraintDef newCheckConstraint) {
        ...
        PgsDdsColumnScriptGenerator columnScriptGenerator = PgsDdsColumnScriptGenerator.Factory.newInstance();
    ...
    public static final class Factory {
        ...
        public static PgsDdsCheckConstraintScriptGenerator newInstance() {
            return new PgsDdsCheckConstraintScriptGenerator();
        }
    }
}
