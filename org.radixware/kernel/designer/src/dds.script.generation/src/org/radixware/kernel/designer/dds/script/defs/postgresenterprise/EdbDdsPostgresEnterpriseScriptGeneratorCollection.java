...
public class EdbDdsPostgresEnterpriseScriptGeneratorCollection implements IDdsScriptGeneratorCollection{
    public EdbDdsPostgresEnterpriseScriptGeneratorCollection(){}

    @Override
    public EDatabaseType getDatabaseType() {
        return EDatabaseType.ENTERPRISEDB;
    }
    ...
    public Map getScriptsCollection() {
        ...
        result.put(DdsViewDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsViewScriptGenerator.Factory.newInstance());
        result.put(DdsTableDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsTableScriptGenerator.Factory.newInstance());
        result.put(DdsPlSqlHeaderDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsPlSqlHeaderScriptGenerator.Factory.newInstance());
        result.put(DdsPlSqlBodyDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsPlSqlBodyScriptGenerator.Factory.newInstance());
        result.put(DdsReferenceDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsReferenceScriptGenerator.Factory.newInstance());
        result.put(DdsColumnDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.Factory.newInstance());
        result.put(DdsIndexDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsIndexScriptGenerator.Factory.newInstance());
        result.put(DdsPrimaryKeyDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsPrimaryKeyScriptGenerator.Factory.newInstance());
        result.put(DdsUniqueConstraintDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsUniqueConstraintScriptGenerator.Factory.newInstance());
        result.put(DdsCheckConstraintDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsCheckConstraintScriptGenerator.Factory.newInstance());
        result.put(DdsTriggerDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsTriggerScriptGenerator.Factory.newInstance());
        result.put(DdsSequenceDef.class, org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsSequenceScriptGenerator.Factory.newInstance());
    ...
    public Comparator getOrderingComparator() {
        return new PostgresEnterpriseCreateOrderComparator();
    }

    private static class PostgresEnterpriseCreateOrderComparator implements Comparator<DefinitionPair> {
...
/*                else if (p1 == 9) {//DdsTypeDef
                    final DdsDefinition def1 = pair1.getNewDefinition();
                    final DdsDefinition def2 = pair2.getNewDefinition();
                    if (def1 instanceof DdsTypeDef && def2 instanceof DdsTypeDef) {
                        if (((DdsTypeDef) def1).isDependsFromOtherType((DdsTypeDef)def2)) {
                            return 1;
                        } else if (((DdsTypeDef) def2).isDependsFromOtherType((DdsTypeDef)def1)) {
                            return -1;                            
                        }
                    }
                }
*/
                    ...
                    final DdsDefinition def2 = pair2.getNewDefinition();
                    if (def1 instanceof DdsTypeDef && def2 instanceof DdsTypeDef) {
                        return DdsScriptInternalUtils.getSequentialNumber4TheDefinitionInTheModule((DdsTypeDef)def2)
                             - DdsScriptInternalUtils.getSequentialNumber4TheDefinitionInTheModule((DdsTypeDef)def1);
                    }
                }
        ...
        public String toString() {
            return "PostgresEnterpriseCreateOrderComparator{" + '}';
        }
    }
}
