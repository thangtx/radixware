...
public class OraDdsCheckConstraintScriptGenerator extends OraDdsConstraintScriptGenerator<DdsCheckConstraintDef> {

    protected OraDdsCheckConstraintScriptGenerator() {
    }
    ...
    public boolean isModifiedToDrop(DdsCheckConstraintDef oldCheckConstraint, DdsCheckConstraintDef newCheckConstraint) {
        ...
        OraDdsColumnScriptGenerator columnScriptGenerator = OraDdsColumnScriptGenerator.Factory.newInstance();
    ...
    public static final class Factory {
        ...
        public static OraDdsCheckConstraintScriptGenerator newInstance() {
            return new OraDdsCheckConstraintScriptGenerator();
        }
    }
}
