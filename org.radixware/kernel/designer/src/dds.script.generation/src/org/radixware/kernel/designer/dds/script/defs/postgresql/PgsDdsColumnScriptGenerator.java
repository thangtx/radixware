...
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.BLOB;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.CHAR;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.CLOB;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.NUMBER;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.RAW;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.TIMESTAMP;
import static org.radixware.kernel.designer.dds.script.defs.postgresenterprise.EdbDdsColumnScriptGenerator.VARCHAR2;

public class PgsDdsColumnScriptGenerator implements IDdsDefinitionScriptGenerator<DdsColumnDef> {

    protected PgsDdsColumnScriptGenerator() {
    }
    ...
    public void getColumnScript(CodePrinter cp, DdsColumnDef column) {
        cp.print(column.getDbName()).print(' ').print(buildDbType(column));
...
//            throw new UnsupportedOperationException("Expressilns are not supported in the columns");
    ...
    public static final class Factory {
        ...
        public static PgsDdsColumnScriptGenerator newInstance() {
            return new PgsDdsColumnScriptGenerator();
        }
    }
}
