...
public class PgsDdsPrimaryKeyScriptGenerator implements IDdsDefinitionScriptGenerator<DdsPrimaryKeyDef> {

    protected PgsDdsPrimaryKeyScriptGenerator() {
    }
...
//        DdsIndexScriptGenerator generator = new DdsIndexScriptGenerator();
    ...
    public static final class Factory {
        ...
        public static PgsDdsPrimaryKeyScriptGenerator newInstance() {
            return new PgsDdsPrimaryKeyScriptGenerator();
        }
    }
}
