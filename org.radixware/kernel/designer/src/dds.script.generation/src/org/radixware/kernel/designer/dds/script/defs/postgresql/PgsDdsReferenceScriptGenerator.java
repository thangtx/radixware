 ...
 *
 */
public class PgsDdsReferenceScriptGenerator extends PgsDdsConstraintScriptGenerator<DdsReferenceDef> {

    protected PgsDdsReferenceScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static PgsDdsReferenceScriptGenerator newInstance() {
            return new PgsDdsReferenceScriptGenerator();
        }
    }
}
