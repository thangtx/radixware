...
public class PgsDdsUniqueConstraintScriptGenerator extends PgsDdsConstraintScriptGenerator<DdsUniqueConstraintDef> {
    ...
    protected PgsDdsUniqueConstraintScriptGenerator() {
    }
    ...
    public boolean isModifiedToDrop(DdsUniqueConstraintDef oldUc, DdsUniqueConstraintDef newUc) {
        ...
        PgsDdsIndexScriptGenerator indexScriptGenerator = PgsDdsIndexScriptGenerator.Factory.newInstance();
    ...
    public static final class Factory {
        ...
        public static PgsDdsUniqueConstraintScriptGenerator newInstance() {
            return new PgsDdsUniqueConstraintScriptGenerator();
        }
    }
}
