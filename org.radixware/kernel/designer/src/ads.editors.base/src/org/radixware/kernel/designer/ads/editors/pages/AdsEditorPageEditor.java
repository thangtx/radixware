...
//                        lastSelectedRadioButton = customButton;
    ...
    private void prepareWebCustomView() {
        ...
        for (AdsEditorPageDef.PagePropertyRef prop : adsEditorPageDef.getProperties()) {
            AdsDefinition propDef = prop.findProperty();
            AdsRwtWidgetDef editor = new AdsRwtWidgetDef(AdsMetaInfo.RWT_PROP_EDITOR);
            editor.setName(propDef.getName() + "Widget");
            editor.setWeight(0.0);
            editor.getProperties().add(new IntProperty("gridColumn", prop.getColumn()));
            editor.getProperties().add(new IntProperty("gridRow", prop.getRow()));
            editor.getProperties().add(new IntProperty("colSpan", prop.getColumnSpan()));
            editor.getProperties().add(new PropertyRefProperty("property", prop.getId().toString()));
            editor.getProperties().add(new StringProperty("objectName", propDef.getName() + "Widget"));
    ...
    private void prepareExplorerCustomView() {
        ...
        for (AdsEditorPageDef.PagePropertyRef prop : adsEditorPageDef.getProperties()) {
            ...
            label.setWeight(0.0);
            label.getProperties().add(new PropertyRefProperty("property", prop.getId().toString()));
            ...
            layout.getItems().add(new AdsLayout.WidgetItem(label, prop.getRow(), prop.getColumn() * 2, 1, 1));
            ...
            editor.getProperties().add(new RectProperty("geometry", 0, 0, 100, 20));
            layout.getItems().add(new AdsLayout.WidgetItem(editor, prop.getRow(), prop.getColumn() * 2 + 1, 1, 2 * prop.getColumnSpan() - 1));
