...
public class AdsClassCatalogNode extends AdsObjectNode<AdsClassCatalogDef> {

    @NodeFactoryRegistration
    public static class Factory implements INodeFactory<AdsClassCatalogDef> {

        @Override // Registered in layer.xml
        public RadixObjectNode newInstance(AdsClassCatalogDef ddsPlSqlObject) {
            return new AdsClassCatalogNode(ddsPlSqlObject);
        }
    }

    public AdsClassCatalogNode(AdsClassCatalogDef definition) {
