...
public class UdsDefinitionReloadAction extends CookieAction {

    public static class Cookie implements Node.Cookie {

        private final UdsDefinition definition;

        public Cookie(UdsDefinition definition) {
    ...
    protected void performAction(Node[] nodes) {
        for (Node node : nodes) {
            final Cookie cookie = node.getCookie(UdsDefinitionReloadAction.Cookie.class);
            if (cookie != null) {
