...
class HtmlNameSupportFactoriesManager extends ExtensionsManager<IHtmlNameSupportFactory> {

    public HtmlNameSupportFactoriesManager() {
        super(HtmlNameSupportFactoryRegistration.SECTION_NAME, IHtmlNameSupportFactory.class);
    }
}
