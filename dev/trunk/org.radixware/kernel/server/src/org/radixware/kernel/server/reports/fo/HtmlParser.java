...
public class HtmlParser {
    ...
    private final static String htmlTag = "!HTML_TEXT";
    ...
    public static List<CellContents> getCellContant(final AdsReportCell cell) {
        ...
        if (text != null && !text.isEmpty()) {
            ...
            cellContants.addAll(parseHtmlText(text, new CellContents(content)));
        }
    ...
    private static List<CellContents> parseHtmlText(String htmlText, final CellContents cellContent) {
        List<CellContents> cellContants = new ArrayList();
        ...
        if (start == -1) {
            ...
            while (start < htmlText.length() && (start = htmlText.indexOf('<', start)) != -1) {
                ...
                } else if (checkNext(htmlText, start, htmlTag) != -1) {
    ...
    static class AttrInfo {
        ...
        AttrInfo(String value, int length) {
            this.value = value;
            this.length = length;
        }
