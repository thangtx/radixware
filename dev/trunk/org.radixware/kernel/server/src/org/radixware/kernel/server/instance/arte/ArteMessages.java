...
public final class ArteMessages {
    ...
    public static volatile String USAGE_GRAPH;
    ...
    static final String MLS_ID_INSUF_ARTE_COUNT = "mlbadcXCB5KK6HMJH7NP6E642OHPOMXY-mlsGVK53K2MINGYBEJPIE4NV7LLEY";// MLS "Instance \"%1\" has insufficient ARTEs count", Warning, ARTE_POOL
    static final String MLS_ID_ERR_ON_ARTE_INST_INIT = "mlbadcXCB5KK6HMJH7NP6E642OHPOMXY-mlsN5BQ7VKUIZFSRND2L56RBBU6WM";// MLS "Instance \"%1\" can't init new ARTE: %2", Error, ARTE_POOL
    static final String MLS_ID_ERR_ON_ARTE_INST_STOP = "mlbadcXCB5KK6HMJH7NP6E642OHPOMXY-mls4FR67PQAU5A2XNUKNCZ3XSNVHY";// MLS "Error on ARTE \"%1\" stopping: %2", Error, ARTE_POOL
