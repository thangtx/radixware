...
@Deprecated
public final class NetHubUnitTracer extends LocalTracer {

    private final Unit unit;
    private final String eventSource;
    private final String prefixForPlainMess;

    public NetHubUnitTracer(final Unit unit, final String eventSource, final String prefixForPlainMess) {
        super();
        this.unit = unit;
