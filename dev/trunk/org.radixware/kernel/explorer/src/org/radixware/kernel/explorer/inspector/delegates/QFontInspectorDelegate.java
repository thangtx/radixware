...
import org.radixware.kernel.explorer.inspector.propertyEditors.QFontPropertyEditor;


public class QFontInspectorDelegate implements InspectorDelegate{

@Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
       return new QFontPropertyEditor(environment, parent);
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(QFont.class);
    }
