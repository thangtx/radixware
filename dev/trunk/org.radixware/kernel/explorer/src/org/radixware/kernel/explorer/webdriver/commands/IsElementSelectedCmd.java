...
final class IsElementSelectedCmd extends GuiCmd{        
    ...
    public JSONObject execute(final WebDrvSession session, final WebDrvUri uri, final JSONObject parameter) throws WebDrvException {
        ...
        final boolean isSelected = session.getUIElements().getUIElementReference(uri.getElementId()).isSelected();
        return new WebDrvSessionCommandResult(isSelected);
    }
}
