...
final class XmlValBinEditor extends ValBinEditor {
    ...
    public XmlValBinEditor(final IClientEnvironment environment, final EditMaskNone editMask, final boolean mandatory, final boolean readOnly, final SchemaType schemaType) {
    ...
    @Override
    protected ValidationResult calcValidationResult(final Bin value) {
