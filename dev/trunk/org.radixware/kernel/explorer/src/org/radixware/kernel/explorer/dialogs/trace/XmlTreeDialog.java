...
public class XmlTreeDialog extends QDialog {

    private XmlTree xmlTree = new XmlTree(this);
    private Finder finder;
    private final ExplorerSettings settings;

    public XmlTreeDialog(ExplorerSettings settings, QWidget parent) {
        super(parent);
    ...
    private void setupUi() {
        ...
        findButton.clicked.connect(finder, "showDialog()");
        ...
        findNextButton.clicked.connect(finder, "find()");
