...
public interface MonitoringTreeItemDecoratorV2 extends MonitoringTreeItemDecorator {
    
    public void prepare(UnitsWidget widget, SysMonitoringRq rq, SysMonitoringRs rs, SysMonitoringRs prevRs);
