...
import org.radixware.kernel.explorer.inspector.propertyEditors.ErrorPropertyEditor;
import org.radixware.kernel.explorer.inspector.propertyEditors.IPropertyEditor;


public class ErrorInspectorDelegate implements InspectorDelegate {

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new ErrorPropertyEditor(environment, parent);
    }
    ...
    public Set<Class> getSupportedClasses() {
       return Collections.<Class>singleton(Error.class);
    }
