...
import org.radixware.kernel.explorer.inspector.propertyEditors.EditMaskPropertyEditor;
import org.radixware.kernel.explorer.inspector.propertyEditors.IPropertyEditor;


public class EditMaskDelegate implements InspectorDelegate{

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new EditMaskPropertyEditor(environment, parent);
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(EditMask.class);
    }
