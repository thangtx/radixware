...
final class XmlValBoolEditor extends ValBoolEditor {

    private final SchemaType schemaType;

    public XmlValBoolEditor(final IClientEnvironment environment, final EditMask editMask, final boolean mandatory, final boolean readOnly, final SchemaType schemaType) {
        super(environment, null, editMask, mandatory, readOnly);
        this.schemaType = schemaType;
    }

    public SchemaType getSchameType() {
        return schemaType;
    }

    @Override
    protected ValidationResult calcValidationResult(final Boolean value) {
