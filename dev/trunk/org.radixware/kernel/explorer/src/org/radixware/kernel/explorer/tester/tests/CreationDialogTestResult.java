...
public class CreationDialogTestResult extends TestResult {

    public CreationDialogTestResult(Selector selector) {
        super(selector.getEnvironment(), selector);
        this.type = TesterConstants.OBJ_SELECTOR_CREATIONDIALOG.getTitle();
    }
}
