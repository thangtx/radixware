...
abstract class SqmlTag_AbstractReference extends SqmlTag {
    ...
    public SqmlTag_AbstractReference(final IClientEnvironment environment,final long pos,final boolean isDeprecated) {
        super(environment,pos, isDeprecated);
    }

    public SqmlTag_AbstractReference(final IClientEnvironment environment,final SqmlTag tag) {
        super(environment,tag);
    }
    
    public SqmlTag_AbstractReference(final IClientEnvironment environment,final long pos) {
