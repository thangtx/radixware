...
public class QRegionPropertyEditor extends ValStrEditor implements IPropertyEditor {

    private final ValueListenerController valListenerController = new ValueListenerController();

    public QRegionPropertyEditor(IClientEnvironment environment, QWidget parent) {
        ...
        childPropEditor.addValueListener(new ValueListener() {
            ...
            public void onChangeValue(Object newValue) {
                try {
                    ...
                    QRegionPropertyEditor.super.getEnvironment().getTracer().error(ex);
                }
            }
        });
    }
