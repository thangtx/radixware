...
public interface InspectorDelegate {
    ...
    IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment);

    IPropertyValueReader createReaderForClass(Class cl);

    IPropertyValueWriter createWriterForClass(Class cl);

    String getDisplayStringForValue(WidgetProperty property);

    List<WidgetProperty> getChildProperties(WidgetProperty property);
