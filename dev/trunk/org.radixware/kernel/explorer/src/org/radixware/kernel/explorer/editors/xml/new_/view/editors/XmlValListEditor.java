...
final class XmlValListEditor extends ValListEditor {

    private final SchemaType schemaType;

    public XmlValListEditor(final IClientEnvironment environment, final EditMaskList editMask, final boolean mandatory, final boolean readOnly, final SchemaType schemaType) {
