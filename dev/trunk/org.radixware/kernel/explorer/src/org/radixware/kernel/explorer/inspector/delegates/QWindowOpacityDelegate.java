...
import org.radixware.kernel.explorer.inspector.propertyEditors.QWindowOpacityPropertyEditor;


public class QWindowOpacityDelegate implements InspectorDelegate{

    @Override
    public IPropertyEditor createEditorForClass(Class cl, QWidget parent, IClientEnvironment environment) {
        return new QWindowOpacityPropertyEditor();
    }
    ...
    public Set<Class> getSupportedClasses() {
        return Collections.<Class>singleton(double.class);
    }
