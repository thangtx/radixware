...
public class QMarginsPropertyEditor extends ValStrEditor implements IPropertyEditor {

    private final ValueListenerController valListenerController = new ValueListenerController();

    public QMarginsPropertyEditor(IClientEnvironment environment, QWidget parent) {
        ...
        childPropEditor.addValueListener(new ValueListener() {
            ...
            public void onChangeValue(Object newValue) {
                try {
                    ...
                    QMarginsPropertyEditor.super.getEnvironment().getTracer().error(ex);
                }
            }
        });
    }
