...
public class ThisTableSqlIdTranslator extends SqmlTagTranslator{
    private final ISqmlTableDef presentationClassDef;
    
    public ThisTableSqlIdTranslator(final boolean isValid,final ISqmlTableDef presentationClassDef){
        super(isValid);
    ...
    public String getDisplayString() {
        return isValid? "ThisId" : "???ThisTableId???";
    }
    ...
    public String getToolTip() {
        if(isValid){
            ...
            final String tableTitle = presentationClassDef.getTitle();
