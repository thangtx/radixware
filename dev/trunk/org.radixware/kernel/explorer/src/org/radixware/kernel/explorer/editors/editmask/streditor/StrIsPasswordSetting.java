...
final class StrIsPasswordSetting extends AbstractCheckableSetting implements IEditMaskEditorSetting{
       
    public StrIsPasswordSetting(final IClientEnvironment environment, final QWidget parent) {
        super(parent);
        final String title = environment.getMessageProvider().translate("EditMask", "Password");
        this.setText(title);
    ...
    public void addToXml(final org.radixware.schemas.editmask.EditMask editMask) {
        editMask.getStr().setIsPassword(this.isChecked());
    }
    ...
    public void loadFromXml(final org.radixware.schemas.editmask.EditMask editMask) {
        ...
        if(ems.isSetIsPassword()) {
            this.setChecked(ems.getIsPassword());
        } else {
            setDefaultValue();
        }
    }
    ...
    public void setDefaultValue() {
        ...
        final boolean value = editMask.isPassword();
        this.setChecked(value);
    }

    @Override
    public EEditMaskOption getOption() {
        return EEditMaskOption.STR_IS_PASSWORD;
    }
}
