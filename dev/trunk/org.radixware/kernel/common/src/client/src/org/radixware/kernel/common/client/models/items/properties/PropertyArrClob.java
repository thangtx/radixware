...
public class PropertyArrClob extends PropertyArr<ArrStr> {

    public PropertyArrClob(Model owner, RadPropertyDef propDef) {
        super(owner, propDef);
    }
    ...
    public void setValObjectImpl(Object x) {
        setInternalVal((ArrStr) x);
    }

    @Override
    public final EValType getType() {
        return EValType.ARR_CLOB;
    }
}
