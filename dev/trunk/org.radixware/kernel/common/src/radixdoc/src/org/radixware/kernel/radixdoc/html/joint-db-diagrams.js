...
var isRectOverlaps = function (objA, objB) {
	var rectA = g.rect(objA.attributes.position.x, objA.attributes.position.y, objA.getWidth(), objA.getHeight());
	var rectB = g.rect(objB.attributes.position.x, objB.attributes.position.y, objB.getWidth(), objB.getHeight());
...
// Utility function for linking diagram elements.
// In JSON-meta info we have only the names of elements,
// but to make element references we need elements IDs
var getElementByName = function(graph, name) {
