...
public class AdsIncludeObjectParamChecker extends AdsDefinitionChecker<AdsIncludeObject.Param> {

    public AdsIncludeObjectParamChecker() {
    }

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return AdsIncludeObject.Param.class;
    }
