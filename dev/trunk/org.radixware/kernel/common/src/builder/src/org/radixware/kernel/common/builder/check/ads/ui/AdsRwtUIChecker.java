...
public class AdsRwtUIChecker extends AdsDefinitionChecker<AdsRwtUIDef> {

    @Override
    public Class<? extends RadixObject> getSupportedClass() {
        return AdsRwtUIDef.class;
    }

    @Override
    public void check(AdsRwtUIDef ui, IProblemHandler problemHandler) {
