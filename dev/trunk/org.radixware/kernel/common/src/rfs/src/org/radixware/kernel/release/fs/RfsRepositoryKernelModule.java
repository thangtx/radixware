...
public class RfsRepositoryKernelModule extends RfsRepositoryModule<KernelModule> {

    public RfsRepositoryKernelModule(RfsRepositorySegment<KernelModule> segment, String dirName) {
