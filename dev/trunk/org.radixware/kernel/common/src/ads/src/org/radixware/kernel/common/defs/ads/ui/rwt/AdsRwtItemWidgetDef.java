...
public class AdsRwtItemWidgetDef extends AdsRwtWidgetDef {

    public AdsRwtItemWidgetDef(RadixObject container, Widget xWidget) {
        super(container, xWidget);
    }

    public AdsRwtItemWidgetDef(Widget xWidget) {
        super(xWidget);
    }

    public AdsRwtItemWidgetDef(String className) {
        super(className);
    }

    public AdsRwtItemWidgetDef(RadixObject container, String className) {
        super(container, className);
    }

    public AdsRwtItemWidgetDef(Id id, String className) {
        super(id, className);
    }
