...
public abstract class Members<T extends AdsDefinition & IAdsClassMember> extends AdsDefinitions<T> implements IAdsClassMember {

    protected Members(AdsClassDef owner) {
        super(owner);
    }

    protected Members(IAdsClassMember owner) {
        super((AdsDefinition) owner);
    }
    ...
    abstract MembersGroup<?> getOwnerGroup();
}
