...
public class JMLEqualExpression extends EqualExpression implements IJMLExpression {

    private Expression substitution;
    private boolean wasResoved = false;

    public JMLEqualExpression(Expression left, Expression right, int operator) {
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if (this.left instanceof IJMLExpression) {
            ...
            Expression s = ((IJMLExpression) this.left).getSubstitution(scope);
            if (s != null) {
                this.left = s;
            }
        }
        ...
        if (this.right instanceof IJMLExpression) {
            ...
            Expression s = ((IJMLExpression) this.right).getSubstitution(scope);
            if (s != null) {
                this.right = s;
            }
        }
