...
public class AdsObjectCommandDef extends AdsScopeCommandDef {

    public static final class Factory extends AdsScopeCommandDef.Factory {

        public static AdsObjectCommandDef newInstance() {
            return new AdsObjectCommandDef();
        }

        public static AdsObjectCommandDef newInstance(Id id) {
            return new AdsObjectCommandDef(id);
        }
    }

    AdsObjectCommandDef(Command xCommand) {
        super(xCommand);
    }

    public AdsObjectCommandDef() {
        super("newCommand");
    }

    AdsObjectCommandDef(Id id) {
        super(id, "newCommand");
    }

    @Override
    public ECommandScope getScope() {
        return ECommandScope.OBJECT;
    }
}
