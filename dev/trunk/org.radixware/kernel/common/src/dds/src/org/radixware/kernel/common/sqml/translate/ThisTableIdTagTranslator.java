...
class ThisTableIdTagTranslator<T extends ThisTableIdTag> extends SqmlTagTranslator<T> {

    public ThisTableIdTagTranslator(IProblemHandler problemHandler) {
    ...
    public void translate(T tag, CodePrinter cp) {
        ...
        cp.printStringLiteral(thisTable.getId().toString());
    }
}
