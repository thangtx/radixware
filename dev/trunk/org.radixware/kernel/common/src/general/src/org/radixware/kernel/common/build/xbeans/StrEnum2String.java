...
class StrEnum2String implements TypeMapper {

    Class cls;

    private IKernelStrEnum valueOf(String v) {
        try {
            return (IKernelStrEnum) cls.getMethod("getForValue", new Class[]{String.class}).invoke(null, new Object[]{v});
