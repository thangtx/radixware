...
class NestedScmlPrinter4PostgresEnterprise extends NestedScmlCodePrinter {

    private static final String COMMAND_SEPARATOR = "\n/\n\n";
//    private static final String COMMAND_SEPARATOR = ";\n\n";

    protected NestedScmlPrinter4PostgresEnterprise(final ScmlCodePrinter container) {
        super(container);
