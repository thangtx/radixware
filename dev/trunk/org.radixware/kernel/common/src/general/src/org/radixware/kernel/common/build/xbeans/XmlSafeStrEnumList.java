...
public class XmlSafeStrEnumList extends XmlListImpl {

    private static final long serialVersionUID = -2409849867270355413L;
    private final TypeMapper mapperTo, mapperFrom;

    @SuppressWarnings("unchecked")
    public XmlSafeStrEnumList(Class enumClass, SchemaType type, boolean complex) {
        super(type, complex);
        mapperTo = new SafeStrEnum2SafeString(enumClass);
