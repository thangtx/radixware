...
public class PropBinEditor extends PropEditor {
    ...
    private static class ValEditorFactoryImpl extends AbstractValEditorFactoryImpl<Bin>{
        ...
        public IValEditor createValEditor(final EValType valType, final EditMask editMask, final IClientEnvironment env) {
            final ValEditorController controller = new ValBinEditorController(env){
                @Override
                protected DisplayController<Bin> createDisplayController() {
