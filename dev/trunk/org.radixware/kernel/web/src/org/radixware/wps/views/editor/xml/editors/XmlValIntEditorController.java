...
final class XmlValIntEditorController extends ValIntEditorController {

    private final SchemaType schemaType;
    private boolean validationEnabled;

    public XmlValIntEditorController(IClientEnvironment env, final SchemaType schemaType) {
        super(env);
