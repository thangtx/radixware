...
import org.radixware.wps.views.editors.valeditors.ValBinEditorController;


final class XmlValBinEditorController extends ValBinEditorController {

    private final SchemaType schemaType;
    private boolean validationEnabled;

    public XmlValBinEditorController(final IClientEnvironment env, final SchemaType schemaType) {
        super(env);
    ...
    @Override
    protected ValidationResult calcValidationResult(Bin value) {
