...
final class XmlValBoolEditorController extends AdvancedValBoolEditorController<Boolean> {
    ...
    public XmlValBoolEditorController(final IClientEnvironment env, final SchemaType schemaType) {
        super(env);
    ...
    @Override
    protected ValidationResult calcValidationResult(Boolean value) {
