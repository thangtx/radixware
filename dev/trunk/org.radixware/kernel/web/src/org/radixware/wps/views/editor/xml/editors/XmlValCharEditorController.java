...
final class XmlValCharEditorController extends ValCharEditorController {

    private final SchemaType schemaType;
    private boolean validationEnabled;

    public XmlValCharEditorController(final IClientEnvironment environment, final SchemaType schemaType) {
        super(environment);
