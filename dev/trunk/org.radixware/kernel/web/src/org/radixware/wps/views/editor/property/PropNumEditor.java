...
public class PropNumEditor extends PropEditor {
    ...
    private static class ValEditorFactoryImpl extends AbstractValEditorFactoryImpl<BigDecimal> {
        ...
        public IValEditor createValEditor(final EValType valType, final EditMask editMask, final IClientEnvironment env) {
            final ValEditorController controller = new ValNumEditorController(env) {
                @Override
                protected DisplayController<BigDecimal> createDisplayController() {
    ...
    private static class ValBoolEditorFactoryImpl extends AbstractValEditorFactoryImpl<BigDecimal> {
        ...
        @Override
        public IValEditor createValEditor(final EValType valType, final EditMask editMask, final IClientEnvironment env) {
            final ValEditorController controller = new AdvancedValBoolEditorController<BigDecimal>(env) {
                @Override
                protected DisplayController<BigDecimal> createDisplayController() {
    ...
    private static ValEditorFactory createValEditorFactoryInstance(Property prop) {
        if (prop.getEditMask() instanceof EditMaskNum) {
