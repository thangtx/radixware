...
abstract class DelegatedRadixResultSet implements RadixResultSet {
    protected final ResultSet delegate;
    protected final IRadixJdbcWrapper objWrapper;

    DelegatedRadixResultSet(ResultSet delegate, IRadixJdbcWrapper objWrapper) {
    ...
    public Boolean getNullableBool(int columnIndex) throws SQLException {
        ...
        Boolean result = wasNull() ? null : value;
        return result;
    }
    ...
    public Integer getNullableInt(int columnIndex) throws SQLException {
        ...
        Integer result = wasNull() ? null : value;
        return result;
    }
    ...
    public Long getNullableLong(int columnIndex) throws SQLException {
        ...
        Long result = wasNull() ? null : value;
        return result;
    }
