...
public class NameMatcherFactory {
    ...
    public static NameMatcher createNameMatcher(String textPattern, SearchType type, EChooseDefinitionDisplayMode displayMode) {
        switch (type) {
            case REGEXP:
            case CASE_INSENSITIVE_REGEXP:
                // from org.netbeans.modules.java.source.ui.JavaTypeProvider
                textPattern = removeNonJavaChars(textPattern);
                String pattern = type == SearchType.CASE_INSENSITIVE_EXACT_NAME ? textPattern : textPattern + "*";
