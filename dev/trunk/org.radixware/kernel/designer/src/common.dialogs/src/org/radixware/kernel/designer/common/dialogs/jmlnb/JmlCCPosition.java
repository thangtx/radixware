...
import org.openide.util.NbPreferences;
 ...
 abstract class JmlCCPosition extends BaseAction {

    private Action originalAction;
    
    public JmlCCPosition(String name, Action originalAction) {
    ...
    public String getShortDescription(){
        ...
        String shortDesc;
        try {
            shortDesc = NbBundle.getBundle(JmlKit.class).getString(name); // NOI18N
    ...
    private boolean isUsingCamelCase() {
        Preferences p = NbPreferences.forModule(JmlCCPosition.class);
