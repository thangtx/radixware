 ...
 */
class RadixDataLoader extends DataLoader {
    ...
    @Override
    protected DataObject handleFindDataObject(FileObject fileObject, RecognizedFiles recognized) throws IOException {
        recognized.markRecognized(fileObject);
        return new RadixDataObject(fileObject, this);
    }
    private static final RadixDataLoader RADIX_DATA_LOADER_INSTANCE = new RadixDataLoader();
