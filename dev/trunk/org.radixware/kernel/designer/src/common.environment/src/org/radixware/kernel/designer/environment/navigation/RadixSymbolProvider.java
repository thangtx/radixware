...
public class RadixSymbolProvider implements SymbolProvider {
    ...
    private static class Collector implements IVisitor {
        ...
        public void accept(RadixObject radixObject) {
            ...
            final Map<String, String> symbolTypeTitle2Value = new HashMap<String, String>();
    ...
    private void computeSymbolNames(Project project, Result result, NameMatcher matcher) {
    ...
    public void computeSymbolNames(Context context, Result result) {
        ...
        if (contextProject != null) {
            computeSymbolNames(contextProject, result, matcher);
        } else {
