...
public class BranchHtmlNameSupport extends HtmlNameSupport {
    ...
    public static final class Factory implements IHtmlNameSupportFactory {
        ...
        public HtmlNameSupport newInstance(RadixObject object) {
            return new BranchHtmlNameSupport((Branch) object);
        }
    }

    public BranchHtmlNameSupport(Branch branch) {
        super(branch);
    }

    @Override
    public String getDisplayName() {
        final Branch branch = (Branch) getRadixObject();
        if (branch.getTitle() != null && !branch.getTitle().isEmpty()) {
            return ((Branch) getRadixObject()).getTitle();
        }
