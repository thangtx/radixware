 ...
 *
 */
final class UserReportDataLoader extends DataLoader {

    private UserReportDataLoader() {
    ...
    protected DataObject handleFindDataObject(final FileObject fileObject, final RecognizedFiles recognized) throws IOException {
        ...
        return new UserReportDataObject(fileObject, this);
    }
    private static final UserReportDataLoader RADIX_DATA_LOADER_INSTANCE = new UserReportDataLoader();

    public static UserReportDataLoader getDefault() {
        return RADIX_DATA_LOADER_INSTANCE;
    }
}
