...
public class ReloadRolesAction extends CookieAction {
            ...
            final Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    RadixMutex.writeAccess(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            if (DialogUtils.messageConfirmation("Do you really want to reload all application roles?\nWARNING: ALL UNSAVED CHANGES WILL BE LOST!")) {
                                UserExtensionManager.getInstance().getAppRoles().reload();
                            }
                        }
                    });
                }
