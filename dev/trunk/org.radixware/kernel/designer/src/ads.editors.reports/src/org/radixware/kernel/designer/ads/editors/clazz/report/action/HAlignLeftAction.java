...
public class HAlignLeftAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public HAlignLeftAction(final AdsReportFormDiagram diagram) {
        super("Left", RadixWareIcons.ALIGN.TEXT.LEFT_MIDDLE.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        for (RadixObject obj : diagram.getSelectedObjects()) {
            if (obj instanceof AdsReportCell) {
                ...
                cell.setHAlign(EReportCellHAlign.LEFT);
            }
        }
    }
