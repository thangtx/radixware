...
public class LeftBorderAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public LeftBorderAction(final AdsReportFormDiagram diagram) {
        super("Left Border", RadixWareIcons.BORDER.LEFT_BORDER.getIcon());
