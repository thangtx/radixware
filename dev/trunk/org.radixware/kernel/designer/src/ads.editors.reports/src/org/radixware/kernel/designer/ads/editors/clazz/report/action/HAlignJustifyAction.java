...
public class HAlignJustifyAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public HAlignJustifyAction(final AdsReportFormDiagram diagram) {
        super("Justify", RadixWareIcons.ALIGN.TEXT.JUSTIFY_CENTER.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        for (RadixObject obj : diagram.getSelectedObjects()) {
            if (obj instanceof AdsReportCell) {
                ...
                cell.setHAlign(EReportCellHAlign.JUSTIFY);
            }
        }
    }
