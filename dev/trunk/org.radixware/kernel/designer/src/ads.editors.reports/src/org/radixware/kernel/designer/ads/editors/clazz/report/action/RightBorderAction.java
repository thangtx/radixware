...
public class RightBorderAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public RightBorderAction(final AdsReportFormDiagram diagram) {
        super("Right Border", RadixWareIcons.BORDER.RIGHT_BORDER.getIcon());
...
//                cell.getBorder().setOnBottom(false);
            }
        }
    }
