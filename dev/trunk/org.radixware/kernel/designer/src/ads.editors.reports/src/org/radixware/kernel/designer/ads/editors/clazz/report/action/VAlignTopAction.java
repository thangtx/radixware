...
public class VAlignTopAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public VAlignTopAction(final AdsReportFormDiagram diagram) {
        super("Top", RadixWareIcons.ALIGN.TEXT.CENTER_TOP.getIcon());
    ...
    public void actionPerformed(final ActionEvent e) {
        for (RadixObject obj : diagram.getSelectedObjects()) {
            if (obj instanceof AdsReportCell) {
                ...
                cell.setVAlign(EReportCellVAlign.TOP);
            }
        }
    }
