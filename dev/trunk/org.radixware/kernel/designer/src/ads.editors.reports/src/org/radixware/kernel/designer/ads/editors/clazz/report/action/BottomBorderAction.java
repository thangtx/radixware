...
public class BottomBorderAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public BottomBorderAction(final AdsReportFormDiagram diagram) {
        super("Bottom Border", RadixWareIcons.BORDER.BOTTOM_BORDER.getIcon());
...
//                cell.getBorder().setOnLeft(false);
//                cell.getBorder().setOnRight(false);
//                cell.getBorder().setOnTop(false);
