...
public class WrapWordAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public WrapWordAction(final AdsReportFormDiagram diagram) {
        super("Wrap word",RadixWareIcons.REPORT.WRAP_WORD.getIcon());
