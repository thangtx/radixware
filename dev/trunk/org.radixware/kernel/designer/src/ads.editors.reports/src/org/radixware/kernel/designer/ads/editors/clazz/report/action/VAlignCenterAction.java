...
public class VAlignCenterAction extends AbstractAction {

    private final AdsReportFormDiagram diagram;

    public VAlignCenterAction(final AdsReportFormDiagram diagram) {
        super("Center", RadixWareIcons.ALIGN.TEXT.CENTER_MIDDLE.getIcon());
