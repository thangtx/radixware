...
class IconSupportFactoriesManager extends ExtensionsManager<IIconSupportFactory> {

    public IconSupportFactoriesManager() {
        super(IconSupportFactoryRegistration.SECTION_NAME, IIconSupportFactory.class);
    }
}
