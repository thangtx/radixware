...
public class MsdlHeaderFieldCreature extends MsdlFieldCreature {

    private MsdlStructureHeaderFields owner;
    ...
    public MsdlHeaderFieldCreature(MsdlStructureHeaderFields owner) {
        super(owner);
        this.owner = owner;
    }
