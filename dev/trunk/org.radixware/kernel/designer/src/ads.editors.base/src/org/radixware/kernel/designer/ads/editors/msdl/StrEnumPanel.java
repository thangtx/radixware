...
public class StrEnumPanel extends DefinitionLinkEditPanel implements ChangeListener {

    private StrFieldModel fieldModel;
    public StrEnumPanel(){

    }

    public void open(AdsMsdlSchemeDef schemeDef, StrFieldModel fieldModel) {
        ...
        ChooseDefinitionCfg cfg = ChooseDefinitionCfg.Factory.newInstance(schemeDef, new VisitorProvider() {
            ...
            public boolean isTarget(RadixObject radixObject) {
                ...
                if (radixObject instanceof AdsEnumDef) {
                    ret = (((AdsEnumDef) radixObject).getItemType() == EValType.STR) || 
                        (((AdsEnumDef) radixObject).getItemType() == EValType.CHAR);
                }
                return ret;
            }
        });
        ...
        if (stringId != null) {
            ...
            Definition def = AdsSearcher.Factory.newAdsDefinitionSearcher(schemeDef).findById(id).get();
