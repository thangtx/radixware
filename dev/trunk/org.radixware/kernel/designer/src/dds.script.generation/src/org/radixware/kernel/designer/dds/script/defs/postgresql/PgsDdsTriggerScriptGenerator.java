 ...
 */
public class PgsDdsTriggerScriptGenerator implements IDdsDefinitionScriptGenerator<DdsTriggerDef> {

    protected PgsDdsTriggerScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static PgsDdsTriggerScriptGenerator newInstance() {
            return new PgsDdsTriggerScriptGenerator();
        }
    }
