 ...
 *
 */
public class EdbDdsReferenceScriptGenerator extends EdbDdsConstraintScriptGenerator<DdsReferenceDef> {

    protected EdbDdsReferenceScriptGenerator() {
    }
    ...
    public void getCreateScript(CodePrinter cp, DdsReferenceDef reference, IScriptGenerationHandler handler) {
        ...
        cp.print('\t').print("add constraint ").print(reference.getDbName()).print(" foreign key (").print(childColumns).println(")")
          .print("\treferences ").print(parentTable.getDbName()).print(" (").print(parentColumns).print(")");
    ...
    public static void getEnableDisableScript(DdsReferenceDef reference, CodePrinter cp, boolean enable) {
        if (enable) {
            new EdbDdsReferenceScriptGenerator().getCreateScript(cp,reference,null);
        }
        else {
            new EdbDdsReferenceScriptGenerator().getDropScript(cp,reference);
        }
    }
    ...
    public static final class Factory {
        ...
        public static EdbDdsReferenceScriptGenerator newInstance() {
            return new EdbDdsReferenceScriptGenerator();
        }
    }
}
