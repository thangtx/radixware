...
public class OraDdsUniqueConstraintScriptGenerator extends OraDdsConstraintScriptGenerator<DdsUniqueConstraintDef> {
    ...
    protected OraDdsUniqueConstraintScriptGenerator() {
    }
    ...
    public boolean isModifiedToDrop(DdsUniqueConstraintDef oldUc, DdsUniqueConstraintDef newUc) {
        ...
        OraDdsIndexScriptGenerator indexScriptGenerator = OraDdsIndexScriptGenerator.Factory.newInstance();
    ...
    public static final class Factory {
        ...
        public static OraDdsUniqueConstraintScriptGenerator newInstance() {
            return new OraDdsUniqueConstraintScriptGenerator();
        }
    }
}
