...
public abstract class PgsDdsPlSqlPartScriptGenerator<T extends DdsPlSqlPartDef> implements IDdsDefinitionScriptGenerator<T> {

    protected PgsDdsPlSqlPartScriptGenerator() {
    }
    ...
    protected void printSqlClassName(CodePrinter cp, T part) {
        ...
        if (plSqlObject instanceof DdsTypeDef) {
            ...
            throw new IllegalStateException("Illegal object in " + PgsDdsPlSqlHeaderScriptGenerator.class.getName() + ": " + String.valueOf(plSqlObject));
        }
    }
