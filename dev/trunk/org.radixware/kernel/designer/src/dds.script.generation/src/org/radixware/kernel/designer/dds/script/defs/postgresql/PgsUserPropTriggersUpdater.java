...
public class PgsUserPropTriggersUpdater {
    ...
    public PgsUserPropTriggersUpdater(final DdsTableDef table) {
        this.table = table;
    }
    ...
    public static void update(DdsTableDef table) {
        final PgsUserPropTriggersUpdater updater = new PgsUserPropTriggersUpdater(table);
        updater.update();
    }
