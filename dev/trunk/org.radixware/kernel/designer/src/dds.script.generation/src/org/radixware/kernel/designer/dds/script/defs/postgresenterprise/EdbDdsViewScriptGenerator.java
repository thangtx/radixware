...
public class EdbDdsViewScriptGenerator implements IDdsDefinitionScriptGenerator<DdsViewDef> {

    protected EdbDdsViewScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static EdbDdsViewScriptGenerator newInstance() {
            return new EdbDdsViewScriptGenerator();
        }
    }
}
