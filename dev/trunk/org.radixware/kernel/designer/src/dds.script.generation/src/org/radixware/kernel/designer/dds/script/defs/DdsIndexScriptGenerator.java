...
public class DdsIndexScriptGenerator<T extends DdsIndexDef> implements IDdsDefinitionScriptGenerator<T> {

    protected DdsIndexScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static DdsIndexScriptGenerator newInstance() {
            return new DdsIndexScriptGenerator();
        }
    }
