...
public class PgsDdsTableScriptGenerator implements IDdsDefinitionScriptGenerator<DdsTableDef> {

    protected PgsDdsTableScriptGenerator() {
    }
...
//      
    ...
    private String getCreateScriptImpl(CodePrinter cp, DdsTableDef table, IScriptGenerationHandler handler, boolean createIntermediateTable, boolean alwaysCreateInDb) {
        ...
        PgsDdsColumnScriptGenerator columnScriptGenerator = new PgsDdsColumnScriptGenerator();
...
//        }
    ...
    public static void printCopyDataFromIntermediateScript(DdsTableDef table, String from, CodePrinter printer, boolean alwaysCreateInDb) {
        try(final InputStream is = PgsDdsTableScriptGenerator.class.getResourceAsStream("copyContent.txt");) {
    ...
    public static final class Factory {
        ...
        public static PgsDdsTableScriptGenerator newInstance() {
            return new PgsDdsTableScriptGenerator();
        }
    }
}
