...
public class OraDdsIndexScriptGenerator implements IDdsDefinitionScriptGenerator<DdsIndexDef> {

    protected OraDdsIndexScriptGenerator() {
    }
...
//        DdsIndexScriptGenerator generator = new DdsIndexScriptGenerator();
    ...
    public static final class Factory {
        ...
        public static OraDdsIndexScriptGenerator newInstance() {
            return new OraDdsIndexScriptGenerator();
        }
    }
