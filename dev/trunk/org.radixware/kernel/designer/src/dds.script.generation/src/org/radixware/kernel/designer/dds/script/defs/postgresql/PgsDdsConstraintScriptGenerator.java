...
public abstract class PgsDdsConstraintScriptGenerator<T extends DdsConstraintDef> implements IDdsDefinitionScriptGenerator<T> {

    protected PgsDdsConstraintScriptGenerator() {
    }
