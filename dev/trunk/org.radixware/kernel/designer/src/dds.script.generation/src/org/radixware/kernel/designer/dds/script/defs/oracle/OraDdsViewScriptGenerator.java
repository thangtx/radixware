...
public class OraDdsViewScriptGenerator implements IDdsDefinitionScriptGenerator<DdsViewDef> {

    protected OraDdsViewScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static OraDdsViewScriptGenerator newInstance() {
            return new OraDdsViewScriptGenerator();
        }
    }
}
