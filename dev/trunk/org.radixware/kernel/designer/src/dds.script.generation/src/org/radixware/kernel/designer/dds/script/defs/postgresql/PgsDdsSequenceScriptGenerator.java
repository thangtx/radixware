 ...
 */
public class PgsDdsSequenceScriptGenerator implements IDdsDefinitionScriptGenerator<DdsSequenceDef> {

    protected PgsDdsSequenceScriptGenerator() {
    }
    ...
    public static final class Factory {
        ...
        public static PgsDdsSequenceScriptGenerator newInstance() {
            return new PgsDdsSequenceScriptGenerator();
        }
    }
}
