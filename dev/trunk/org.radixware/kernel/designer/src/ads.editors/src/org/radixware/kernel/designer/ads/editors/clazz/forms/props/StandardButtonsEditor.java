...
public class StandardButtonsEditor extends PropertyEditorSupport implements ExPropertyEditor {

    private PropertyEnv env;

    public StandardButtonsEditor(UIPropertySupport property) {
        super(property);
    }
    ...
    public java.awt.Component getCustomEditor () {
        return new StandardButtonsPanel(this, env);
    }
