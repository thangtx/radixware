...
public class ReturnPanel extends EditorDialog.EditorPanel<AdsReturnObject> {

    public ReturnPanel(AdsReturnObject node) {
        super(node);
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(250, 45));
        setMinimumSize(new java.awt.Dimension(250, 45));
        setPreferredSize(new java.awt.Dimension(250, 45));
        setRequestFocusEnabled(false);

        labelName.setText(org.openide.util.NbBundle.getMessage(ReturnPanel.class, "ReturnPanel.labelName.text")); // NOI18N
    ...
    public String getTitle() {
        return NbBundle.getMessage(getClass(), "CTL_ReturnPanel");
    }
}
