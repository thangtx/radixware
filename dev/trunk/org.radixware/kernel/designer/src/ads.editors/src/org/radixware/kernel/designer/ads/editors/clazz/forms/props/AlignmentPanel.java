...
public class AlignmentPanel extends JPanel implements PropertyChangeListener {

    private PropertyEnv env;
    private AlignmentEditor editor;

    AlignmentPanel(AlignmentEditor editor, PropertyEnv env) {
        this.env = env;
        this.editor = editor;
        ...
        textH.setModel(new DefaultComboBoxModel(
                new EAlignment[] { EAlignment.AlignLeft, EAlignment.AlignHCenter, EAlignment.AlignRight, EAlignment.AlignJustify }
        ));
        textV.setModel(new DefaultComboBoxModel(
                new EAlignment[] { EAlignment.AlignTop, EAlignment.AlignVCenter, EAlignment.AlignBottom }
        ));
        textH.setSelectedItem(hAlign);
        textV.setSelectedItem(vAlign);

        textH.setEditable(!getNode().isReadOnly());
        textV.setEditable(!getNode().isReadOnly());
    }
    ...
    private void initComponents() {
        ...
        labelH.setText(org.openide.util.NbBundle.getMessage(AlignmentPanel.class, "AlignmentPanel.labelH.text")); // NOI18N

        labelV.setText(org.openide.util.NbBundle.getMessage(AlignmentPanel.class, "AlignmentPanel.labelV.text")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(textV, 0, 246, Short.MAX_VALUE)
                    .addComponent(textH, 0, 246, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (PropertyEnv.PROP_STATE.equals(evt.getPropertyName()) && evt.getNewValue() == PropertyEnv.STATE_VALID) {
            AdsUIProperty.SetProperty prop = getProperty();
            prop.setValues(new UIEnum[] {
                (EAlignment)textH.getSelectedItem(),
                (EAlignment)textV.getSelectedItem()
            });
