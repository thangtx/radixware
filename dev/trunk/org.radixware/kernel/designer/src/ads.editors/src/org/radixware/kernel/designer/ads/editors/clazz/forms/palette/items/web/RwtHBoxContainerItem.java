...
public class RwtHBoxContainerItem extends Item {

    public static final RwtHBoxContainerItem DEFAULT = new RwtHBoxContainerItem();

    public RwtHBoxContainerItem() {
        super(Group.GROUP_WEB_CONTAINERS, "Horizontal Box Container", AdsMetaInfo.RWT_HORIZONTAL_BOX_CONTAINER);
    }
