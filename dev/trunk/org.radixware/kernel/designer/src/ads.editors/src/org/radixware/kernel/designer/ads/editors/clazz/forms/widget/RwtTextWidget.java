...
public class RwtTextWidget extends BaseWidget {

    public RwtTextWidget(GraphSceneImpl scene, AdsRwtWidgetDef node) {
        super(scene, node);
    }
    ...
    protected List<WidgetAction> getInitialActions(GraphSceneImpl scene, RadixObject node) {
        ...
        if (!AdsMetaInfo.RWT_COMMAND_PUSH_BUTTON.equals(
                AdsUIUtil.getUiClassName(node))) {
