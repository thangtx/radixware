...
class DocManagerCreatorItem extends CommonFormItem {

    public static final String CLASS_NAME = AdsAppObject.DOC_MANAGER_CLASS_NAME;

    public DocManagerCreatorItem() {
        super(CLASS_NAME, Group_.GROUP_APPBLOCKS, RadixResourceBundle.getMessage(DocManagerCreatorItem.class, "DocManagerCreator"), AdsDefinitionIcon.WORKFLOW.DOC_MANAGER_CREATOR);
    }
