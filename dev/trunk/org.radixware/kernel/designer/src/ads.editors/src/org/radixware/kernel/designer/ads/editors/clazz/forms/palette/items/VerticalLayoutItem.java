...
public class VerticalLayoutItem extends Item {

    public static final VerticalLayoutItem DEFAULT = new VerticalLayoutItem();

  

    public VerticalLayoutItem() {
        super(Group.GROUP_LAYOUTS, NbBundle.getMessage(VerticalLayoutItem.class, "Vertical_Layout"), AdsMetaInfo.VERTICAL_LAYOUT_CLASS);
    }

    private final static Color BORDER_COLOR = new Color(0, 255, 255);
