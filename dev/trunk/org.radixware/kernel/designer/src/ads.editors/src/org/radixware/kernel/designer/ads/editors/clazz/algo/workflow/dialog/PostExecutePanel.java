...
public class PostExecutePanel extends EditorDialog.EditorPanel<AdsAppObject> {

    public PostExecutePanel(AdsAppObject node) {
        super(node);
        initComponents();
        add(editor);
    }
    ...
    @Override
    public void init() {
        editor.open(obj.getPostExecute());
    }
    ...
    public String getTitle() {
        return NbBundle.getMessage(getClass(), "CTL_PostExecute");
    }
