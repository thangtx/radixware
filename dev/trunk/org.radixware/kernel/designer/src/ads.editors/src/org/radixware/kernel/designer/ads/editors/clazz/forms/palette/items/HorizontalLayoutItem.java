...
public class HorizontalLayoutItem extends Item {
    ...
    public static final HorizontalLayoutItem DEFAULT = new HorizontalLayoutItem();

    

    public HorizontalLayoutItem() {
        super(Group.GROUP_LAYOUTS, NbBundle.getMessage(HorizontalLayoutItem.class, "Horizontal_Layout"), AdsMetaInfo.HORIZONTAL_LAYOUT_CLASS);
    }

    private final static Color BORDER_COLOR = new Color(255, 0, 255);
