...
public class ValListPanel extends EditorDialog.EditorPanel<AdsItemWidgetDef> {

    public ValListPanel(AdsAbstractUIDef uiDef,AdsItemWidgetDef widget) {
        super(uiDef,widget);
        initComponents();
    }
...
/*
    @Override
    public void apply() {
        Items items = widget.getItems();
        items.clear();
        for (WidgetItem item: listModel.getItems()) {
...
*/
    ...
    private class TableModel extends AbstractTableModel implements ListSelectionListener {
        ...
        private String[] columns = new String[] {
            NbBundle.getBundle(ValListPanel.class).getString("PropTable.Name"),
            NbBundle.getBundle(ValListPanel.class).getString("PropTable.Value")
        };
