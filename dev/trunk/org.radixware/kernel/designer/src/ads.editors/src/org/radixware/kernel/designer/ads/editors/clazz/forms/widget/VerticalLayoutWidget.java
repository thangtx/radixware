...
public class VerticalLayoutWidget extends BaseWidget {

    public VerticalLayoutWidget(GraphSceneImpl scene, AdsLayout node) {
        super(scene, node);
        setLayoutProcessor(new VerticalLayoutProcessor(this, node));
    }
