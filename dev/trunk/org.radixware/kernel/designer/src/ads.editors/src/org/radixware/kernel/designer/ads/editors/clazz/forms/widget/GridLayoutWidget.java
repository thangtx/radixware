...
public class GridLayoutWidget extends BaseWidget {

    public GridLayoutWidget(GraphSceneImpl scene, AdsLayout node) {
        super(scene, node);
        setLayoutProcessor(new GridLayoutProcessor(this, node));
    }
