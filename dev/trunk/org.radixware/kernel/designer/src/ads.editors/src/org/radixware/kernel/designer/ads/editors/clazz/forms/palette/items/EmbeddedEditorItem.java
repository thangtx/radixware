...
public class EmbeddedEditorItem extends Item {

    public static final EmbeddedEditorItem DEFAULT = new EmbeddedEditorItem();


    public EmbeddedEditorItem() {
        super(Group.GROUP_RADIX_WIDGETS, NbBundle.getMessage(EmbeddedEditorItem.class, "Embedded_Editor"), AdsMetaInfo.EMBEDDED_EDITOR_CLASS);
    }
