...
public class FinishWidget extends BaseWidget<AdsFinishObject> {
    
    private final Image image = GraphUtil.IMAGE_FINISH;
    
    public FinishWidget(GraphSceneImpl scene, AdsFinishObject node) {
