...
import org.radixware.kernel.designer.ads.editors.clazz.forms.dialog.ValListPanel;


public class ValListEditorWidget extends ValEditorWidget {

    public ValListEditorWidget(GraphSceneImpl scene, AdsWidgetDef node) {
        super(scene, node);
    }
...
//        return EditorDialog.execute(new ValListPanel(widget));
//    }
}
