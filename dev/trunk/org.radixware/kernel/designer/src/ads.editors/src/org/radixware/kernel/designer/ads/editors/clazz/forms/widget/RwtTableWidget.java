...
public class RwtTableWidget extends BaseWidget {

    public RwtTableWidget(GraphSceneImpl scene, AdsRwtItemWidgetDef node) {
        super(scene, node);

        //TableItem.syncProperties(node);
    }
    ...
    protected boolean notifyEdited() {
        if (getNode() instanceof AdsItemWidgetDef) {
