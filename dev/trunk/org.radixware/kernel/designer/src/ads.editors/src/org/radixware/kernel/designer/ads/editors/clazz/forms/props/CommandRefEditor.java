...
public class CommandRefEditor extends PropertyEditorSupport implements ExPropertyEditor {

    private PropertyEnv env;

    public CommandRefEditor(UIPropertySupport property) {
        super(property);
    }
    ...
    public String getAsText() {
        AdsUIProperty.CommandRefProperty prop = (AdsUIProperty.CommandRefProperty)getValue();
        AdsCommandDef commandDef = prop.findCommand();
        return String.format("%s", commandDef != null ? commandDef.getName() : "");
    }
    ...
    public java.awt.Component getCustomEditor () {
        return new CommandRefPanel(this, env);
    }
