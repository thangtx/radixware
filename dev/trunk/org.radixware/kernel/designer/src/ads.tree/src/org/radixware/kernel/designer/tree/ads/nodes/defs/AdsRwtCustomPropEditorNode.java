...
class AdsRwtCustomPropEditorNode extends AdsCustomViewNode<AdsRwtCustomPropEditorDef> {

    @NodeFactoryRegistration
    public static final class Factory implements INodeFactory<AdsRwtCustomPropEditorDef> {

        @Override
        public Node newInstance(AdsRwtCustomPropEditorDef object) {
            return new AdsRwtCustomPropEditorNode(object);
        }
    }

    private static class Model extends Children.Keys<AdsPropEditorModelClassDef> {

        private Model(AdsRwtCustomPropEditorDef definition) {
            super();
    ...
    private AdsRwtCustomPropEditorNode(AdsRwtCustomPropEditorDef definition) {
