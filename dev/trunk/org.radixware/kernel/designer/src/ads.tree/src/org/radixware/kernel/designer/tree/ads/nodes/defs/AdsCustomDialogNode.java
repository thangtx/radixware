...
class AdsCustomDialogNode extends AdsCustomViewNode<AdsCustomDialogDef> {

    @NodeFactoryRegistration
    public static final class Factory implements INodeFactory<AdsCustomDialogDef> {

        @Override
        public Node newInstance(AdsCustomDialogDef object) {
            return new AdsCustomDialogNode(object);
        }
    }

    private static class Model extends Children.Keys<AdsDialogModelClassDef> {

        private Model(AdsCustomDialogDef definition) {
            super();
    ...
    private AdsCustomDialogNode(AdsCustomDialogDef definition) {
