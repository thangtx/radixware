...
public class AdsPropertyHtmlNameSupport extends HtmlNameSupport {
    ...
    protected AdsPropertyHtmlNameSupport(AdsPropertyDef property) {
        super(property);
        ...
        property.getAccessFlags().getAccessFlagsChangesSupport().addEventListener(profileChangeListener);
    }
    ...
    public static final class Factory implements IHtmlNameSupportFactory {
        ...
        public HtmlNameSupport newInstance(RadixObject object) {
            return new AdsPropertyHtmlNameSupport((AdsPropertyDef) object);
        }
    }
}
