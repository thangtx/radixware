...
public class PreviewOpenAction extends AbstractAction implements LookupListener, ContextAwareAction {
    
    private Lookup context;
    Lookup.Result<RadixObject> lkpInfo;
    
    public PreviewOpenAction() {
        this(Utilities.actionsGlobalContext());
    }
 
    PreviewOpenAction(Lookup context) {
    ...
    public Action createContextAwareInstance(Lookup context) {
        return new PreviewOpenAction(context);
    }
