...
public class GoToServerCommandHandlerAction extends AdsDefinitionAction {
            ...
            provider = new VisitorProvider() {
                ...
                public boolean isTarget(RadixObject radixObject) {
                    if (radixObject instanceof AdsCommandHandlerMethodDef){
                        if (((AdsDefinition) radixObject).getUsageEnvironment().equals(ERuntimeEnvironmentType.SERVER)){
    ...
    public String getName() {
        return "Go to Server Side Command Handler...";
    }
