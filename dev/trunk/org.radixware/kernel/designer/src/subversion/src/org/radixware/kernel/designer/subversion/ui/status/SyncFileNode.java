 ...
 * from the CvsFileNode which serves as the 'data' node for this 'visual' node.
 */
public class SyncFileNode extends AbstractNode {
    ...
    /**
     * Provide cookies to actions. If a node represents primary file of a
     * DataObject it has respective DataObject cookies.
     */
    @Override
