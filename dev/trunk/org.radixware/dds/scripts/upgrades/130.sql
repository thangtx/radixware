...
begin
   ...
   if vSaveData=1 then
            ...
            RDX_AUDIT.addChangedValueInt(vChangeData,'col2X4UBSDEPBBG5LYPLRDF6YSOIU',:old.THREADSTACKWRITEINTERVALSEC,:new.THREADSTACKWRITEINTERVALSEC);
            RDX_AUDIT.addChangedValueInt(vChangeData,'colHIKMV3NWRZCDXHXWRERFBXVFT4',:old.THREADSTACKWRITETIMEOUTSEC,:new.THREADSTACKWRITETIMEOUTSEC);
   end if;
...
begin
   ...
   if vSaveData=1 then
            ...
            RDX_AUDIT.addChangedValueInt(vChangeData,'colLKDHAIE6KZH7BKNDT4ALVM2HCI',:old.THREADSTACKWRITEINTERVALSEC,:new.THREADSTACKWRITEINTERVALSEC);
            RDX_AUDIT.addChangedValueInt(vChangeData,'colIG74GFS3QNA5PFW3P27DVCWSPQ',:old.THREADSTACKWRITETIMEOUTSEC,:new.THREADSTACKWRITETIMEOUTSEC);
            RDX_AUDIT.addChangedValueInt(vChangeData,'colA4GEOKW25BFTZIBY5PJ5W3KTCI',:old.THREADSTACKHISTORYSTOREDAYS,:new.THREADSTACKHISTORYSTOREDAYS);
   end if;
