...
alter table RDX_INSTANCE
	add INSTSTATEHISTORYSTOREDAYS NUMBER(9,0) null
/

alter table RDX_SYSTEM rename column THREADSTACKHISTORYSTOREDAYS to INSTSTATEHISTORYSTOREDAYS
/

alter table RDX_INSTANCE rename column THREADSTACKWRITEINTERVALSEC to INSTSTATEGATHERPERIODSEC
/

alter table RDX_SYSTEM rename column THREADSTACKWRITEINTERVALSEC to INSTSTATEGATHERPERIODSEC
/

alter table RDX_INSTANCE rename column THREADSTACKWRITETIMEOUTSEC to INSTSTATEFORCEDGATHERPERIODSEC
/

alter table RDX_SYSTEM rename column THREADSTACKWRITETIMEOUTSEC to INSTSTATEFORCEDGATHERPERIODSEC
/



update RDX_SYSTEM set INSTSTATEGATHERPERIODSEC = 10, INSTSTATEFORCEDGATHERPERIODSEC = 60
/

alter table RDX_SYSTEM
	modify (INSTSTATEFORCEDGATHERPERIODSEC default 60 null)
/

alter table RDX_SYSTEM
	modify (INSTSTATEGATHERPERIODSEC default 10 null)
/



update RDX_INSTANCE set INSTSTATEGATHERPERIODSEC = -1, INSTSTATEFORCEDGATHERPERIODSEC = -1
/

alter table RDX_INSTANCE
	modify (INSTSTATEFORCEDGATHERPERIODSEC default -1)
/

alter table RDX_INSTANCE
	modify (INSTSTATEGATHERPERIODSEC default -1)
/
